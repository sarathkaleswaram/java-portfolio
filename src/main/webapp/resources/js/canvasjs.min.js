...
(function() {
    ...
    function wa(a, c, b) {
        ...
        if (isNaN(e)) {
            try {
                ...
                V.style.display = "";
                V.setAttribute("style", a);
                e = Math.round(V.offsetHeight);
    ...
    function fa(a, c, b) {
        if (v && za) {
            ...
            a.width = c * L;
            a.height = b * L;
            oa !== ga && (a.style.width = c + "px", a.style.height = b + "px", d.scale(L, L))
    ...
    function R(a, c, b) {
        c.getAttribute("state") !== b && (c.setAttribute("state", b), c.setAttribute("type", "button"), c.style.position =
            "relative", c.style.margin = "0px 0px 0px 0px", c.style.padding = "3px 4px 0px 4px", c.style.cssFloat = "left", c.setAttribute("title", a._cultureInfo[b + "Text"]), c.innerHTML = "<img style='height:16px;' src='" + Ga[b].image + "' alt='" + a._cultureInfo[b + "Text"] + "' />")
    }
        ...
        (this._container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) ? (this._container.innerHTML = "", c = a = 0, a = this._options.width ? this.width : 0 < this._container.clientWidth ? this._container.clientWidth : this.width, c = this._options.height ? this.height : 0 < this._container.clientHeight ? this._container.clientHeight :
            ...
            this._container.appendChild(this._canvasJSContainer), this.canvas = W(a, c), this.canvas.style.position = "absolute", this.canvas.getContext && (this._canvasJSContainer.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d"), this.ctx.textBaseline = "top", Ea(this.ctx), v ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = W(a, c), this.plotArea.canvas.style.position = "absolute", this.plotArea.canvas.setAttribute("class", "plotAreaCanvas"), this._canvasJSContainer.appendChild(this.plotArea.canvas), this.plotArea.ctx =
                ...
                this._canvasJSContainer.appendChild(this._toolBar), this.bounds = {
                    ...
                    d._mouseEventHandler(a)
                }), I(this.overlaidCanvas, window.navigator.msPointerEnabled ?
    ...
    function ca(a, c) {
        ca.base.constructor.call(this, "Title", c, a.theme);
        this.chart = a;
        this.canvas = a.canvas;
        this.ctx = this.chart.ctx;
        if (B(this._options.margin) && a._options.subtitles)
            for (var b = a._options.subtitles,
                    d = 0; d < b.length; d++)
                if ((B(b[d].horizontalAlign) && "center" === this.horizontalAlign || b[d].horizontalAlign === this.horizontalAlign) && (B(b[d].verticalAlign) && "top" === this.verticalAlign || b[d].verticalAlign === this.verticalAlign) && !b[d].dockInsidePlotArea === !this.dockInsidePlotArea) {
                    this.margin = 0;
                    break
                }
    ...
    function ka(a, c, b) {
        ka.base.constructor.call(this, "Legend", c, b);
        this.chart = a;
        this.canvas = a.canvas;
        this.ctx = this.chart.ctx;
    ...
    function pa(a, c) {
        pa.base.constructor.call(this, c);
        this.chart = a;
        this.canvas = a.canvas;
        this.ctx = this.chart.ctx
    }
    ...
    function U(a, c, b, d, e) {
        U.base.constructor.call(this, "DataSeries", c, b);
        this.chart = a;
        this.canvas = a.canvas;
    ...
    function E(a, c, b, d) {
        ...
        if (this._options.stripLines && 0 < this._options.stripLines.length)
            for (this.stripLines = [], c = 0; c < this._options.stripLines.length; c++) this.stripLines.push(new la(this.chart, this._options.stripLines[c], a.theme, ++this.chart._eventManager.lastObjectId, this));
    ...
    function la(a, c, b, d, e) {
        la.base.constructor.call(this, "StripLine", c, b, e);
        this.id = d;
        this.chart = a;
        this.ctx = this.chart.ctx;
        this.label =
    ...
    function S(a, c, b) {
        S.base.constructor.call(this, "ToolTip", c, b);
        this.chart = a;
        this.canvas = a.canvas;
        this.ctx = this.chart.ctx;
    ...
    function ba(a) {
        ...
        this.ghostCanvas = W(this.chart.width, this.chart.height);
    ...
    function da(a) {
        var c;
        a && ea[a] && (c = ea[a]);
        da.base.constructor.call(this, "CultureInfo", c)
    }
    ...
    var v = !!document.createElement("canvas").getContext,
        ...
        ra = function() {
            ...
            return function(h, p, n) {
                ...
                "UTC:" === p.slice(0, 4) && (p = p.slice(4), s = !0);
                n = s ? "getUTC" : "get";
                var t = h[n + "Date"](),
                    u = h[n + "Day"](),
                    w = h[n + "Month"](),
                    ...
                    H = h[n + "Seconds"](),
                    B = h[n + "Milliseconds"](),
                    A = s ? 0 : h.getTimezoneOffset();
                return n = p.replace(a, function(a) {
                    switch (a) {
                        case "D":
                            return t;
                        case "DD":
                        ...
                        case "YY":
                            return O(String(z).slice(-2), 2);
                        case "YYY":
                            return O(String(z).slice(-3), 3);
                        case "YYYY":
                            return O(z,
                                4);
                        case "h":
                        ...
                        case "TT":
                            return 12 > x ? "AM" : "PM";
                        case "K":
                            return s ? "UTC" : (String(h).match(f) || [""]).pop().replace(g, "");
                        case "z":
        ...
        Y = function(a, c, b) {
            ...
            for (var u = 0; h && u < h.length; u++)
                if (c = h[u], "." === c && 0 > p) p = u;
                    ...
                    if ("%" === c) g *= 100;
                        ...
                        p = u + c.length - 1;
                        continue
                    } else "E" !== c[0] && "e" !== c[0] || "0" !== c[c.length - 1] || (s = !0);
                    0 > p ? (n.push(c), "#" === c || "0" === c ? m++ : "," === c && q++) : (r.push(c), "#" !== c && "0" !== c || l++)
                }
            s && (c = Math.floor(a), t = (0 === c ? "" : String(c)).length - m, g /= Math.pow(10, t));
            0 > p && (p = u);
            g = (a * g).toFixed(l);
            c = g.split(".");
            g = (c[0] + "").split("");
            a = (c[1] +
                "").split("");
            g && "0" === g[0] && g.shift();
            for (u = s = h = l = p = 0; 0 < n.length;)
                if (c = n.pop(), "#" === c || "0" === c)
                    if (p++, p === m) {
                        var w = g,
                            g = [];
                        if ("0" === c)
                            for (c = m - l - (w ? w.length : 0); 0 < c;) w.unshift("0"), c--;
                        for (; 0 < w.length;) b = w.pop() + b, u++, 0 === u % s && (h === q && 0 < w.length) && (b = f + b);
                        d && (b = "-" + b)
                    } else 0 < g.length ? (b = g.pop() + b, l++, u++) : "0" === c && (b = "0" + b, l++, u++), 0 === u % s && (h === q && 0 < g.length) && (b = f + b);
            else "E" !== c[0] && "e" !== c[0] || "0" !== c[c.length - 1] || !/[eE][+-]*[0]+/.test(c) ? "," === c ? (h++, s = u, u = 0, 0 < g.length && (b = f + b)) : b = 1 < c.length &&
                ('"' === c[0] && '"' === c[c.length - 1] || "'" === c[0] && "'" === c[c.length - 1]) ? c.slice(1, c.length - 1) + b : c + b : (c = 0 > t ? c.replace("+", "").replace("-", "") : c.replace("-", ""), b += c.replace(/[0]+/, function(a) {
                    return O(t, a.length)
                }));
            d = "";
            for (f = !1; 0 < r.length;) c = r.shift(), "#" === c || "0" === c ? 0 < a.length && 0 !== Number(a.join("")) ? (d += a.shift(), f = !0) : "0" === c && (d += "0", f = !0) : 1 < c.length && ('"' === c[0] && '"' === c[c.length - 1] || "'" === c[0] && "'" === c[c.length - 1]) ? d += c.slice(1, c.length - 1) : "E" !== c[0] && "e" !== c[0] || "0" !== c[c.length - 1] || !/[eE][+-]*[0]+/.test(c) ?
    ...
    J.prototype.setOptions = function(a, c) {
    ...
    J.prototype.updateOption = function(a) {
    ...
    J.prototype.removeAllEventListeners = function() {
        this._eventListeners = []
    };
    J.prototype.dispatchEvent = function(a, c, b) {
    ...
    A.prototype._updateOptions =
        function() {
            ...
            this.updateOption("colorSet") && (this._selectedColorSet = "undefined" !== typeof X[this.colorSet] ? X[this.colorSet] : X.colorSet1);
            ...
            this._options.zoomEnabled ? (this._zoomButton || (T(this._zoomButton = document.createElement("button")), R(this, this._zoomButton, "pan"), this._toolBar.appendChild(this._zoomButton),
                I(this._zoomButton, "click", function() {
                    ...
                    a.render()
                })), this._resetButton || (T(this._resetButton = document.createElement("button")), R(this, this._resetButton, "reset"), this._toolBar.appendChild(this._resetButton), I(this._resetButton, "click", function() {
                a._toolTip.hide();
                a.zoomEnabled || a.panEnabled ? (a.zoomEnabled = !0, a.panEnabled = !1, R(a, a._zoomButton, "pan"), a._defaultCursor =
            ...
            this._menuButton ?
                this.exportEnabled ? ha(this._menuButton) : T(this._menuButton) : this.exportEnabled && v && (this._menuButton = document.createElement("button"), R(this, this._menuButton, "menu"), this._toolBar.appendChild(this._menuButton), I(this._menuButton, "click", function() {
            ...
            if (!this._dropdownMenu && this.exportEnabled &&
                ...
                I(this._dropdownMenu, "blur", function() {
                    T(a._dropdownMenu);
                ...
                I(c, "mouseover", function() {
                    this.style.backgroundColor = "#EEEEEE"
                }, !0);
                I(c, "mouseout", function() {
            ...
            "none" !== this._toolBar.style.display && this._zoomButton && (this.panEnabled ? R(a,
                a._zoomButton, "zoom") : R(a, a._zoomButton, "pan"), a._resetButton.getAttribute("state") !== a._cultureInfo.resetText && R(a, a._resetButton, "reset"));
    ...
    A.prototype._updateSize = function() {
        ...
        return this.canvas.width !== a * L || this.canvas.height !== c * L ? (fa(this.canvas, a, c), fa(this.overlaidCanvas, a, c), fa(this._eventManager.ghostCanvas, a, c), !0) : !1
    };
    A.prototype._initialize = function() {
        ...
        this.layoutManager = new $(0, 0, this.width, this.height,
            2);
        ...
        if (this._options.data)
            for (var c = 0; c < this._options.data.length; c++)
                if (a++, !this._options.data[c].type || 0 <= A._supportedChartTypes.indexOf(this._options.data[c].type)) {
                    var b = new U(this, this._options.data[c], this.theme, a - 1, ++this._eventManager.lastObjectId);
                    ...
                    null === b.markerSize && (("line" === b.type || "stepLine" === b.type || "spline" === b.type) && b.dataPoints &&
                    ...
                    "bubble" !== b.type && "scatter" !== b.type || !b.dataPoints || (b.dataPoints.some ? b.dataPoints.some(function(a) {
                        return a.x
                    }) && b.dataPoints.sort(va) : b.dataPoints.sort(va));
                    this.data.push(b);
    ...
    A.prototype.render = function(a) {
        ...
        for (a = 0; a < this.data.length; a++)
            if ("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) this.data[a].axisYType && "primary" !== this.data[a].axisYType ? "secondary" === this.data[a].axisYType && (this.axisY2 || ("normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY2 = new E(this, this._options.axisY2, "axisY", "right")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY2 = new E(this,
                ...
                this._axes.push(this.axisX = new E(this, this._options.axisX, "axisX", "left"))), this.data[a].axisX = this.axisX;
        ...
        b ? ha(this._zoomButton, this._resetButton) : (T(this._zoomButton, this._resetButton), this._options.zoomEnabled && (this.zoomEnabled = !0, this.panEnabled = !1));
        this._processData();
        this._options.title && (this._title = new ca(this, this._options.title), this._title.dockInsidePlotArea ? c.push(this._title) : this._title.render());
        if (this._options.subtitles)
            for (a = 0; a < this._options.subtitles.length; a++) this.subtitles = [], b = new ja(this, this._options.subtitles[a]), this.subtitles.push(b),
        ...
        if ("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) E.setLayoutAndRender(this.axisX, this.axisY, this.axisY2, this.plotInfo.axisPlacement, this.layoutManager.getFreeSpace());
        else if ("none" === this.plotInfo.axisPlacement) this.preparePlotArea();
        else return;
        for (a = 0; a < c.length; a++) c[a].render();
        var d = [];
        if (this.animatedRender) {
            var e = W(this.width, this.height);
        ...
        for (a = 0; a < this.plotInfo.plotTypes.length; a++)
            for (c = this.plotInfo.plotTypes[a], b = 0; b < c.plotUnits.length; b++) {
                var f = c.plotUnits[b],
                    g = null;
                f.targetCanvas = null;
                this.animatedRender && (f.targetCanvas = W(this.width, this.height), f.targetCanvasCtx = f.targetCanvas.getContext("2d"));
        ...
        this.animatedRender && 0 < this._indexLabels.length && (a = W(this.width, this.height).getContext("2d"), d.push(this.renderIndexLabels(a)));
        var p = this;
        0 < d.length ? (p.disableToolTip = !0, p._animator.animate(200, p.animationDuration, function(a) {
            p.ctx.clearRect(0, 0, p.width, p.height);
            p.ctx.drawImage(e, 0, 0, Math.floor(p.width * L), Math.floor(p.height * L), 0, 0, p.width, p.height);
        ...
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
            for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, e, f = !1, g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                if ("normal" === h.axisPlacement || "xySwapped" === h.axisPlacement) var m = this.sessionVariables.axisX.newViewportMinimum ?
                    ...
                    l = this.sessionVariables.axisX.newViewportMaximum ? this.sessionVariables.axisX.newViewportMaximum : this._options.axisX && this._options.axisX.viewportMaximum ? this._options.axisX.viewportMaximum : this._options.axisX && this._options.axisX.maximum ? this._options.axisX.maximum : Infinity;
                ...
                for (p = 0; p < h.dataPoints.length; p++) {
                    ...
                    if (0 < p) {
                        ...
                        null !== e && null !== h.dataPoints[p - 1].y && (q = e - h.dataPoints[p - 1].y,
                            0 > q && (q *= -1), c.minDiff > q && 0 !== q && (c.minDiff = q))
                    }
                    if (!(d < m) || n) {
                        if (!n && (n = !0, 0 < p)) {
                            p -= 2;
    ...
    A.prototype._processStackedPlotUnit = function(a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var c =
                    a.axisY.dataInfo, b = a.axisX.dataInfo, d, e, f = !1, g = [], h = [], p = Infinity, n = 0; n < a.dataSeriesIndexes.length; n++) {
                ...
                if (r.dataPoints[m].x && r.dataPoints[m].x.getTime || "dateTime" === r.xValueType) f = !0;
                for (m = 0; m < r.dataPoints.length; m++) {
                    "undefined" === typeof r.dataPoints[m].x && (r.dataPoints[m].x = m);
                    r.dataPoints[m].x.getTime ? (f = !0, d = r.dataPoints[m].x.getTime()) :
                        d = r.dataPoints[m].x;
                    B(r.dataPoints[m].y) ? e = 0 : (e = r.dataPoints[m].y, 0 === n && (p = Math.min(e, p)));
                    d < b.min && (b.min = d);
                    d > b.max && (b.max = d);
                    if (0 < m) {
                        var u = d - r.dataPoints[m - 1].x;
                        0 > u && (u *= -1);
                        b.minDiff > u && 0 !== u && (b.minDiff = u);
                        null !== e && null !== r.dataPoints[m - 1].y && (u = e - r.dataPoints[m - 1].y, 0 > u && (u *= -1), c.minDiff > u && 0 !== u && (c.minDiff = u))
                    }
                    if (!(d < s) || l) {
                        if (!l && (l = !0, 0 < m)) {
                            m -= 2;
                        ...
                        if (d > t && !q) q = !0;
                        else if (d > t && q) continue;
                        r.dataPoints[m].label && (a.axisX.labels[d] = r.dataPoints[m].label);
                ...
                this.plotInfo.axisXValueType = r.xValueType = f ? "dateTime" : "number"
            }
            for (m in g) g.hasOwnProperty(m) && !isNaN(m) && (a = g[m], a < c.min && (c.min = Math.min(a, p)), a > c.max && (c.max = a), m < b.viewPortMin || m > b.viewPortMax || (a < c.viewPortMin && (c.viewPortMin = Math.min(a, p)), a > c.viewPortMax && (c.viewPortMax = a)));
            for (m in h) h.hasOwnProperty(m) && !isNaN(m) && (a = h[m], a < c.min && (c.min = Math.min(a,
                p)), a > c.max && (c.max = a), m < b.viewPortMin || m > b.viewPortMax || (a < c.viewPortMin && (c.viewPortMin = Math.min(a, p)), a > c.viewPortMax && (c.viewPortMax = a)))
        }
    };
    A.prototype._processStacked100PlotUnit = function(a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, e, f = !1, g = !1, h = !1, p = [], n = 0; n < a.dataSeriesIndexes.length; n++) {
                var r = this.data[a.dataSeriesIndexes[n]],
                    m = 0,
                    l = !1,
                    q = !1;
                if ("normal" === r.axisPlacement || "xySwapped" === r.axisPlacement) var s = this.sessionVariables.axisX.newViewportMinimum ?
                    this.sessionVariables.axisX.newViewportMinimum : this._options.axisX && this._options.axisX.viewportMinimum ? this._options.axisX.viewportMinimum : this._options.axisX && this._options.axisX.minimum ? this._options.axisX.minimum : -Infinity,
                ...
                for (m = 0; m < r.dataPoints.length; m++) {
                    "undefined" === typeof r.dataPoints[m].x && (r.dataPoints[m].x = m);
                    r.dataPoints[m].x.getTime ? (f = !0, d = r.dataPoints[m].x.getTime()) : d = r.dataPoints[m].x;
                    e = B(r.dataPoints[m].y) ? null : r.dataPoints[m].y;
                    d < b.min && (b.min = d);
                    d > b.max && (b.max = d);
                    if (0 < m) {
                        var u = d - r.dataPoints[m - 1].x;
                        0 > u && (u *= -1);
                        b.minDiff > u && 0 !== u && (b.minDiff = u);
                        B(e) || null === r.dataPoints[m - 1].y || (u = e - r.dataPoints[m - 1].y, 0 > u && (u *= -1), c.minDiff >
                            u && 0 !== u && (c.minDiff = u))
                    }
                    if (!(d < s) || l) {
                        if (!l && (l = !0, 0 < m)) {
                        ...
                        d < b.viewPortMin && (b.viewPortMin = d);
                        d > b.viewPortMax && (b.viewPortMax = d);
                        null !== e && (a.yTotals[d] = (a.yTotals[d] ? a.yTotals[d] : 0) + Math.abs(e), 0 <= e ? g = !0 : 0 > e && (h = !0), p[d] = p[d] ? p[d] + Math.abs(e) : Math.abs(e))
                    }
                }
                this.plotInfo.axisXValueType = r.xValueType = f ? "dateTime" : "number"
            }
            g && !h ? (c.max = B(c.viewPortMax) ? 99 : Math.max(c.viewPortMax, 99), c.min =
                B(c.viewPortMin) ? 1 : Math.min(c.viewPortMin, 1)) : g && h ? (c.max = B(c.viewPortMax) ? 99 : Math.max(c.viewPortMax, 99), c.min = B(c.viewPortMin) ? -99 : Math.min(c.viewPortMin, -99)) : !g && h && (c.max = B(c.viewPortMax) ? -1 : Math.max(c.viewPortMax, -1), c.min = B(c.viewPortMin) ? -99 : Math.min(c.viewPortMin, -99));
            c.viewPortMin = c.min;
            c.viewPortMax = c.max;
            a.dataPointYSums = p
        }
        ...
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
            for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, e, f, g, h = !1,
                ...
                var n = this.data[a.dataSeriesIndexes[p]],
                    ...
                    m = !1,
                    l = !1;
                if ("normal" === n.axisPlacement || "xySwapped" === n.axisPlacement) var q = this.sessionVariables.axisX.newViewportMinimum ? this.sessionVariables.axisX.newViewportMinimum : this._options.axisX && this._options.axisX.viewportMinimum ? this._options.axisX.viewportMinimum : this._options.axisX && this._options.axisX.minimum ? this._options.axisX.minimum : -Infinity,
                ...
                if (n.dataPoints[r].x && n.dataPoints[r].x.getTime || "dateTime" === n.xValueType) h = !0;
                for (r = 0; r < n.dataPoints.length; r++) {
                    "undefined" === typeof n.dataPoints[r].x && (n.dataPoints[r].x = r);
                    n.dataPoints[r].x.getTime ? (h = !0, d = n.dataPoints[r].x.getTime()) : d = n.dataPoints[r].x;
                    (e = n.dataPoints[r].y) && e.length && (f = Math.min.apply(null, e), g = Math.max.apply(null,
                        e));
                    d < b.min && (b.min = d);
                    d > b.max && (b.max = d);
                    f < c.min && (c.min = f);
                    g > c.max && (c.max = g);
                    if (0 < r) {
                        var t = d - n.dataPoints[r - 1].x;
                        0 > t && (t *= -1);
                        b.minDiff > t && 0 !== t && (b.minDiff = t);
                        null !== e[0] && null !== n.dataPoints[r - 1].y[0] && (t = e[0] - n.dataPoints[r - 1].y[0], 0 > t && (t *= -1), c.minDiff > t && 0 !== t && (c.minDiff = t))
                    }
                    if (!(d < q) || m) {
                        if (!m && (m = !0, 0 < r)) {
                            r -= 2;
                        ...
                        n.dataPoints[r].label && (a.axisX.labels[d] = n.dataPoints[r].label);
                        d < b.viewPortMin && (b.viewPortMin = d);
                        d > b.viewPortMax && (b.viewPortMax =
                            d);
                        null !== e && (f < c.viewPortMin && (c.viewPortMin = f), g > c.viewPortMax && (c.viewPortMax = g))
                    }
                }
    ...
    A.prototype.getDataPointAtXY = function(a, c, b) {
        ...
        for (b = 0; b < d.length; b++)
            if ("line" === d[b].dataSeries.type || "stepLine" === d[b].dataSeries.type || "area" === d[b].dataSeries.type || "stepArea" === d[b].dataSeries.type)
                if (e =
                    P("markerSize", d[b].dataPoint, d[b].dataSeries) || 8, d[b].distance <= e / 2) {
                    c = !0;
                    break
                }
    ...
    A.prototype.getObjectAtXY = function(a, c, b) {
        ...
        else if (v) d = ya(a, c, this._eventManager.ghostCtx);
        else
    ...
    A.prototype._mouseEventHandler = function(a) {
        if (this.interactivityEnabled)
            if (this._ignoreNextEvent) this._ignoreNextEvent = !1;
                ...
                if (!e) {
                    if (A.capturedEventParam) d =
                        A.capturedEventParam, "mouseup" === b && (A.capturedEventParam = null, d.chart.overlaidCanvas.releaseCapture ? d.chart.overlaidCanvas.releaseCapture() : document.body.removeEventListener("mouseup", d.chart._mouseEventHandler, !1)), d.hasOwnProperty(b) && d[b].call(d.context, c.x, c.y);
                    ...
                    this._toolTip && this._toolTip.enabled && (b = this.plotArea, (c.x < b.x1 || c.x > b.x2 || c.y < b.y1 || c.y > b.y2) &&
                        this._toolTip.hide());
        ...
        if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) && this.isDrag) {
            ...
            if (this.panEnabled || this.zoomEnabled) {
                ...
                g && (this._ignoreNextEvent = !0, this._dispatchRangeEvent("rangeChanging", "zoom"), this.render(), this._dispatchRangeEvent("rangeChanged", "zoom"), g && (this.zoomEnabled && "none" ===
                    this._zoomButton.style.display) && (ha(this._zoomButton, this._resetButton), R(this, this._zoomButton, "pan"), R(this, this._resetButton, "reset")))
            }
        }
        this.isDrag = !1
    };
    A.prototype._plotAreaMouseMove = function(a, c) {
        if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
            ...
            2 < Math.abs(b) && 8 > Math.abs(b) && (this.panEnabled || this.zoomEnabled) ?
                this._toolTip.hide() : this.panEnabled || this.zoomEnabled || this._toolTip.mouseMoveHandler(a, c);
            if ((!e || 2 < Math.abs(b) || !f || 2 < Math.abs(d)) && (this.panEnabled || this.zoomEnabled))
                if (this.panEnabled) e = {
                    ...
                    "pan"), this.dragStartPoint.x = a, this.dragStartPoint.y = c);
                ...
                this.validateRegion(d, g, e ? a : this.plotArea.x2 - this.plotArea.x1, f ? c : this.plotArea.y2 - this.plotArea.y1,
                    "xy" !== this.zoomType).isValid && (this.resetOverlayedCanvas(), this.overlaidCanvasCtx.fillStyle = "#99B2B5");
    ...
    A.prototype._zoomPanToSelectedRegion = function(a, c, b, d, e) {
    ...
    A.prototype.validateRegion =
        function(a, c, b, d, e) {
            ...
            var f = 0 <= this.zoomType.indexOf("x"),
                ...
                n = [],
                r = [];
            this.axisX && f && n.push(this.axisX);
            this.axisY && g && n.push(this.axisY);
            this.axisY2 && g && n.push(this.axisY2);
            for (f = 0; f < n.length; f++) {
                ...
                if (isFinite(g.dataInfo.minDiff))
                    if (!(Math.abs(l - m) < 3 * Math.abs(g.dataInfo.minDiff) || m < g.minimum || l > g.maximum)) p.push(g), r.push({
                        val1: m,
                        val2: l
                    }), h = !0;
                    else if (!e) {
    ...
    A.prototype.preparePlotArea = function() {
        ...
        this.axisX && c ? (a.x1 = this.axisX.lineCoordinates.x1 < this.axisX.lineCoordinates.x2 ? this.axisX.lineCoordinates.x1 : c.lineCoordinates.x1, a.y1 = this.axisX.lineCoordinates.y1 < c.lineCoordinates.y1 ? this.axisX.lineCoordinates.y1 : c.lineCoordinates.y1, a.x2 = this.axisX.lineCoordinates.x2 > c.lineCoordinates.x2 ?
        ...
        a.layoutManager = new $(a.x1,
            a.y1, a.x2, a.y2, 2)
    };
    A.prototype.getPixelCoordinatesOnPlotArea = function(a, c) {
        return {
    ...
    A.prototype.renderIndexLabels = function(a) {
        ...
        for (var c = this.plotArea, b = 0, d = 0, e = 0, f = b = d = 0, g = 0, h = 0, p = 0, n = 0, r = 0; r < this._indexLabels.length; r++) {
            var m = this._indexLabels[r],
                l = m.chartType.toLowerCase(),
                q, s, t = P("indexLabelFontColor", m.dataPoint, m.dataSeries),
                f = P("indexLabelFontSize", m.dataPoint, m.dataSeries),
                g = P("indexLabelFontFamily",
                    m.dataPoint, m.dataSeries),
                p = P("indexLabelFontStyle", m.dataPoint, m.dataSeries),
                n = P("indexLabelFontWeight", m.dataPoint, m.dataSeries);
            q = P("indexLabelBackgroundColor", m.dataPoint, m.dataSeries);
            s = P("indexLabelMaxWidth", m.dataPoint, m.dataSeries);
            var b = P("indexLabelWrap", m.dataPoint, m.dataSeries),
                u = P("indexLabelLineDashType", m.dataPoint, m.dataSeries),
                w = P("indexLabelLineColor", m.dataPoint, m.dataSeries),
                z = B(m.dataPoint.indexLabelLineThickness) ? B(m.dataSeries._options.indexLabelLineThickness) ? 0 : m.dataSeries._options.indexLabelLineThickness :
                m.dataPoint.indexLabelLineThickness,
                h = 0 < z ? Math.min(10, ("normal" === this.plotInfo.axisPlacement ? this.plotArea.height : this.plotArea.width) << 0) : 0,
                x = {
                    percent: null,
                    total: null
                },
            ...
            var H = m.dataPoint.indexLabelFormatter ? m.dataPoint.indexLabelFormatter(v) : m.dataPoint.indexLabel ? this.replaceKeywordsWithValue(m.dataPoint.indexLabel, m.dataPoint, m.dataSeries, null, m.indexKeyword) : m.dataSeries.indexLabelFormatter ? m.dataSeries.indexLabelFormatter(v) : m.dataSeries.indexLabel ? this.replaceKeywordsWithValue(m.dataSeries.indexLabel, m.dataPoint, m.dataSeries, null, m.indexKeyword) : null;
            if (null !== H && "" !== H) {
                var x = P("indexLabelPlacement", m.dataPoint, m.dataSeries),
                    v = P("indexLabelOrientation", m.dataPoint, m.dataSeries),
                    A = m.direction,
                    d = m.dataSeries.axisX,
                    e = m.dataSeries.axisY,
                    t = new M(a, {
                        x: 0,
                        y: 0,
                        maxWidth: s ? s : 0.5 * this.width,
                        maxHeight: b ? 5 * f : 1.5 * f,
                ...
                t.measureText();
                if (0 <= l.indexOf("line") || 0 <= l.indexOf("area") || 0 <= l.indexOf("bubble") || 0 <= l.indexOf("scatter")) {
                    if (m.dataPoint.x < d.viewportMinimum || m.dataPoint.x >
                        d.viewportMaximum || m.dataPoint.y < e.viewportMinimum || m.dataPoint.y > e.viewportMaximum) continue
                } else if (0 <= l.indexOf("column")) {
                    if (m.dataPoint.x < d.viewportMinimum || m.dataPoint.x > d.viewportMaximum || m.bounds.y1 > c.y2 || m.bounds.y2 < c.y1) continue
                } else if (0 <= l.indexOf("bar")) {
                    if (m.dataPoint.x < d.viewportMinimum || m.dataPoint.x > d.viewportMaximum || m.bounds.x1 > c.x2 || m.bounds.x2 < c.x1) continue
                } else if (m.dataPoint.x < d.viewportMinimum || m.dataPoint.x > d.viewportMaximum) continue;
                f = g = 2;
                "horizontal" === v ? (p = t.width, n = t.height) :
                    (n = t.width, p = t.height);
                if ("normal" === this.plotInfo.axisPlacement) {
                    if (0 <= l.indexOf("line") || 0 <= l.indexOf("area")) x = "auto", g = 4;
                    else if (0 <= l.indexOf("stacked")) "auto" === x && (x = "inside");
                    else if ("bubble" === l || "scatter" === l) x = "inside";
                    q = m.point.x - p / 2;
                    "inside" !== x ? (d = c.y1, e = c.y2, 0 < A ? (s = m.point.y - n - g - h, s < d && (s = "auto" === x ? Math.max(m.point.y, d) + g + h : d + g + h)) : (s = m.point.y + g + h, s > e - n - g - h && (s = "auto" === x ? Math.min(m.point.y, e) - n - g - h : e - n - g - h))) : (d = Math.max(m.bounds.y1, c.y1), e = Math.min(m.bounds.y2, c.y2), b = 0 <= l.indexOf("range") ?
                        0 < A ? Math.max(m.bounds.y1, c.y1) + n / 2 + g : Math.min(m.bounds.y2, c.y2) - n / 2 - g : (Math.max(m.bounds.y1, c.y1) + Math.min(m.bounds.y2, c.y2)) / 2, 0 < A ? (s = Math.max(m.point.y, b) - n / 2, s < d && ("bubble" === l || "scatter" === l) && (s = Math.max(m.point.y - n - g, c.y1 + g))) : (s = Math.min(m.point.y, b) - n / 2, s > e - n - g && ("bubble" === l || "scatter" === l) && (s = Math.min(m.point.y + g, c.y2 - n - g))), s = Math.min(s, e - n))
                } else 0 <= l.indexOf("line") || 0 <= l.indexOf("area") || 0 <= l.indexOf("scatter") ? (x = "auto", f = 4) : 0 <= l.indexOf("stacked") ? "auto" === x && (x = "inside") : "bubble" ===
                ...
                t.y = s;
                t.render(!0);
                z && ("inside" !== x && (0 > l.indexOf("bar") && m.point.x > c.x1 && m.point.x < c.x2 || m.point.x - p - 2 * f - h > c.x1 && m.point.x + p + 2 * f + h < c.x2) && (0 > l.indexOf("column") && m.point.y > c.y1 && m.point.y < c.y2 || m.point.y - n - 2 * g - h > c.y1 && m.point.y + n + 2 * g + h < c.y2)) && (a.lineWidth = z, a.strokeStyle = w ? w : "gray", a.setLineDash && a.setLineDash(G(u, z)), a.beginPath(), a.moveTo(m.point.x, m.point.y), 0 <= l.indexOf("bar") ? a.lineTo(q + (0 < m.direction ? 0 : p), s + ("horizontal" === v ? n : -n) / 2) : 0 <= l.indexOf("column") ? a.lineTo(q +
                    p / 2, s + ((0 < m.direction ? n : -n) + ("horizontal" === v ? n : -n)) / 2) : a.lineTo(q + p / 2, s + ((s < m.point.y ? n : -n) + ("horizontal" === v ? n : -n)) / 2), a.stroke())
            }
        }
        return {
            source: a,
            dest: this.plotArea.ctx,
            animationCallback: D.fadeInAnimation,
            easingFunction: D.easing.easeInQuad,
            animationBase: 0,
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var d = [], e = 0; e < a.dataSeriesIndexes.length; e++) {
                ...
                var h = g.dataPoints,
                    p = "solid";
                if (c.setLineDash) {
                    var n = G(g.nullDataLineDashType, g.lineThickness),
                        p = g.lineDashType,
                        r = G(p, g.lineThickness);
                    c.setLineDash(r)
                }
                var m = g.id;
                ...
                var m = g._colorSet,
                    l = m = g._options.lineColor ? g._options.lineColor :
                    m[0];
                c.strokeStyle = m;
                var q = !0,
                    s = 0,
                ...
                c.beginPath();
                if (0 < h.length) {
                    for (var w = !1, s = 0; s < h.length; s++)
                        if (t = h[s].x.getTime ? h[s].x.getTime() : h[s].x, !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !w)))
                            if ("number" !== typeof h[s].y) 0 < s && !(g.connectNullData || w || q) && (c.stroke(), v && b.stroke()), w = !0;
                            else {
                                ...
                                u = a.axisY.conversionParameters.reference +
                                    a.axisY.conversionParameters.pixelPerUnit * (h[s].y - a.axisY.conversionParameters.minimum) + 0.5 << 0;
                                var z = g.dataPointIds[s];
                                ...
                                if (q || w) {
                                    if (q && 0 < s && w && g.connectNullData)
                                        for (w = s - 1; 0 <= w; w--)
                                            if ("number" === typeof h[w].y) {
                                                var q = !1,
                                                    x = a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit * ((h[w].x.getTime ? h[w].x.getTime() : h[w].x) - a.axisX.conversionParameters.minimum) + 0.5 << 0,
                                                    y = a.axisY.conversionParameters.reference +
                                                    a.axisY.conversionParameters.pixelPerUnit * (h[w].y - a.axisY.conversionParameters.minimum) + 0.5 << 0;
                                                c.beginPath();
                                                c.moveTo(x, y);
                                                v && (b.beginPath(), b.moveTo(x, y));
                                                if (h[w].lineColor && h[w].lineColor !== l || p !== (h[w].lineDashType || g.nullDataLineDashType)) l = h[w].lineColor || m, c.strokeStyle = l, c.setLineDash && h[w].lineDashType && (p = h[w].lineDashType, c.setLineDash(G(p, g.lineThickness)));
                                                break
                                            }!q && g.connectNullData ? (c.setLineDash && (p === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (c.stroke(), p = g.nullDataLineDashType,
                                        c.setLineDash(n)), c.lineTo(t, u), v && b.lineTo(t, u)) : (c.beginPath(), c.moveTo(t, u), v && (b.beginPath(), b.moveTo(t, u)));
                                    w = q = !1
                                } else c.lineTo(t, u), v && b.lineTo(t, u), 0 == s % 500 && (c.stroke(), c.beginPath(), c.moveTo(t, u), v && (b.stroke(), b.beginPath(), b.moveTo(t, u)));
                                s < h.length - 1 && (l !== (h[s].lineColor || m) || p !== (h[s].lineDashType || g.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(t, u), l = h[s].lineColor || m, c.strokeStyle = l, c.setLineDash && (h[s].lineDashType ? (p = h[s].lineDashType, c.setLineDash(G(p, g.lineThickness))) :
                                    (p = g.lineDashType, c.setLineDash(r))));
                                if (0 < h[s].markerSize || 0 < g.markerSize) x = g.getMarkerProperties(s, t, u, c), d.push(x), z = F(z), v && d.push({
                                    x: t,
                                    y: u,
                                    ctx: b,
                                    type: x.type,
                                ...
                                (h[s].indexLabel || g.indexLabel || h[s].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: "line",
                                    dataPoint: h[s],
                                    dataSeries: g,
                                    point: {
            ...
            return {
                source: c,
                dest: this.plotArea.ctx,
                animationCallback: D.xClipAnimation,
                easingFunction: D.easing.linear,
                animationBase: 0
            }
        }
    };
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var d = [], e = 0; e < a.dataSeriesIndexes.length; e++) {
                ...
                if (0 < h.length) {
                    for (var w = !1, s = 0; s < h.length; s++)
                        if (t = h[s].getTime ?
                            h[s].x.getTime() : h[s].x, !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !w)))
                            if ("number" !== typeof h[s].y) 0 < s && !(g.connectNullData || w || q) && (c.stroke(), v && b.stroke()), w = !0;
                            else {
                                var z = u;
                                t = a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit * (t - a.axisX.conversionParameters.minimum) + 0.5 << 0;
                                u = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (h[s].y - a.axisY.conversionParameters.minimum) + 0.5 << 0;
                                var x = g.dataPointIds[s];
                                ...
                                if (q || w) {
                                    if (q && 0 < s && w && g.connectNullData)
                                        for (var y = s - 1; 0 <= y; y--)
                                            if ("number" === typeof h[y].y) {
                                                q = !1;
                                                if (h[y].lineColor && h[y].lineColor !== l || p !== (h[y].lineDashType || g.nullDataLineDashType)) l = h[y].lineColor || m, c.strokeStyle = l, c.setLineDash && h[y].lineDashType && (p = h[y].lineDashType, c.setLineDash(G(p, g.lineThickness)));
                                                w = a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit *
                                                    (h[y].x.getTime ? h[y].x.getTime() : h[y].x - a.axisX.conversionParameters.minimum) + 0.5 << 0;
                                                y = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (h[y].y - a.axisY.conversionParameters.minimum) + 0.5 << 0;
                                                c.beginPath();
                                                c.moveTo(w, y);
                                                c.lineTo(t, y);
                                                v && (b.beginPath(), b.moveTo(w, y), b.lineTo(t, y));
                                                break
                                            }!q && g.connectNullData ? (c.setLineDash && (p === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (c.stroke(), p = g.nullDataLineDashType, c.setLineDash(n)), c.lineTo(t, z), c.lineTo(t, u), v &&
                                        (b.lineTo(t, z), b.lineTo(t, u))) : (c.beginPath(), c.moveTo(t, u), v && (b.beginPath(), b.moveTo(t, u)));
                                    w = q = !1
                                } else c.lineTo(t, z), v && b.lineTo(t, z), c.lineTo(t, u), v && b.lineTo(t, u), 0 == s % 500 && (c.stroke(), c.beginPath(), c.moveTo(t, u), v && (b.stroke(), b.beginPath(), b.moveTo(t, u)));
                                s < h.length - 1 && (l !== (h[s].lineColor || m) || p !== (h[s].lineDashType || g.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(t, u), l = h[s].lineColor || m, c.strokeStyle = l, c.setLineDash && (h[s].lineDashType ? (p = h[s].lineDashType, c.setLineDash(G(p, g.lineThickness))) :
                                    (p = g.lineDashType, c.setLineDash(r))));
                                if (0 < h[s].markerSize || 0 < g.markerSize) z = g.getMarkerProperties(s, t, u, c), d.push(z), x = F(x), v && d.push({
                                    x: t,
                                    y: u,
                                    ctx: b,
                                    type: z.type,
    ...
    A.prototype.renderSpline = function(a) {
        function c(a) {
            ...
            if (0 < a.length) {
                ...
                for (var c = 0; c < a.length - 3; c += 3) b.bezierCurveTo(a[c + 1].x, a[c + 1].y, a[c + 2].x, a[c + 2].y, a[c + 3].x, a[c + 3].y), v && d.bezierCurveTo(a[c + 1].x, a[c + 1].y, a[c + 2].x, a[c + 2].y, a[c + 3].x, a[c + 3].y), 0 < c && 0 === c % 3E3 && (b.stroke(),
                    b.beginPath(), b.moveTo(a[c + 3].x, a[c + 3].y), v && (d.stroke(), d.beginPath(), d.moveTo(a[c + 3].x, a[c + 3].y)));
                b.stroke();
                v && d.stroke()
            }
        }
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var e = [], f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                if (b.setLineDash) {
                    var r =
                        G(h.nullDataLineDashType, h.lineThickness),
                        n = h.lineDashType,
                        m = G(n, h.lineThickness);
                    b.setLineDash(m)
                }
                var l = h.id;
                ...
                b.beginPath();
                if (0 < p.length)
                    for (var x = !1, t = 0; t < p.length; t++)
                        if (u = p[t].getTime ? p[t].x.getTime() : p[t].x, !(u < a.axisX.dataInfo.viewPortMin ||
                                u > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !x)))
                            if ("number" !== typeof p[t].y) 0 < t && !x && (c(z), z = 1 > z.length ? [] : z[z.length - 1], z = h.connectNullData ? [z] : []), x = !0;
                            else {
                                u = a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit * (u - a.axisX.conversionParameters.minimum) + 0.5 << 0;
                                w = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (p[t].y - a.axisY.conversionParameters.minimum) + 0.5 << 0;
                                ...
                                if (x && h.connectNullData) {
                                    if (s && 0 < t)
                                        for (x = t - 1; 0 <= x; x--)
                                            if ("number" === typeof p[x].y) {
                                                z[0] = {
                                                    x: a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit * ((p[x].x.getTime ? p[x].x.getTime() : p[x].x) - a.axisX.conversionParameters.minimum) + 0.5 << 0,
                                                    y: a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (p[x].y - a.axisY.conversionParameters.minimum) + 0.5 << 0
                                                };
                                                if (p[x].lineColor && p[x].lineColor !== q || n !== (p[x].lineDashType ||
                                                        h.nullDataLineDashType)) q = p[x].lineColor || l, b.strokeStyle = q, b.setLineDash && p[x].lineDashType && (n = p[x].lineDashType, b.setLineDash(G(n, h.lineThickness)));
                                                s = !1;
                                                break
                                            }
                                    b.setLineDash && (!s && n === h.lineDashType && h.lineDashType !== h.nullDataLineDashType) && (b.setLineDash(r), z[z.length] = {
                                        x: u,
                                        y: w
                                    }, c(z), z = [], n = h.lineDashType, b.setLineDash(m))
                                }
                                t < p.length - 1 && (q !== (p[t].lineColor || l) || n !== (p[t].lineDashType || h.lineDashType)) && (z[z.length] = {
                                    x: u,
                                    y: w
                                }, c(z), z = [], q = p[t].lineColor || l, b.strokeStyle = q, b.setLineDash && (p[t].lineDashType ?
                                    (n = p[t].lineDashType, b.setLineDash(G(n, h.lineThickness))) : (n = h.lineDashType, b.setLineDash(m))));
                                z[z.length] = {
                                    x: u,
                                    y: w
                                };
                                if (0 < p[t].markerSize || 0 < h.markerSize) s = h.getMarkerProperties(t, u, w, b), e.push(s), y = F(y), v && e.push({
                                    x: u,
                                    y: w,
                                    ctx: d,
                                    type: s.type,
    ...
    var K = function(a, c, b, d, e, f, g, h, p, n, r, m, l) {
        ...
        a.globalAlpha = 1;
        0 < g && (l = 0 === g % 2 ? 0 : 0.5, a.beginPath(), a.lineWidth =
            g, a.strokeStyle = h, a.moveTo(c, b), a.rect(c - l, b - l, d - c + 2 * l, e - b + 2 * l), a.stroke());
        a.restore();
        ...
        !0 === n && (a.save(), a.beginPath(), a.moveTo(c, e), a.lineTo(c + q, e - q), a.lineTo(d - q, e - q), a.lineTo(d, e), a.closePath(), g = a.createLinearGradient((d + c) / 2, e - q, (d + c) / 2,
            e), g.addColorStop(0, f), g.addColorStop(1, "rgba(255, 255, 255, .4)"), a.fillStyle = g, a.fill(), a.restore());
        !0 === r && (a.save(), a.beginPath(), a.moveTo(c, b), a.lineTo(c + q, b + q), a.lineTo(c + q, e - q), a.lineTo(c, e), a.closePath(), g = a.createLinearGradient(c + q, (e + b) / 2, c, (e + b) / 2), g.addColorStop(0, f), g.addColorStop(1, "rgba(255, 255, 255, 0.1)"), a.fillStyle = g, a.fill(), a.restore());
        !0 === m && (a.save(), a.beginPath(), a.moveTo(d, b), a.lineTo(d - q, b + q), a.lineTo(d - q, e - q), a.lineTo(d, e), g = a.createLinearGradient(d - q, (e + b) / 2, d, (e + b) /
    ...
    A.prototype.renderColumn = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null,
                d = this.plotArea,
                e = 0,
                f, g, h, p = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) << 0,
            ...
            isFinite(r) || (r = 0.3 * Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum));
            r = this.dataPointWidth ? this.dataPointWidth : 0.9 * (d.width / Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum) * Math.abs(r) / a.plotType.totalDataSeries) << 0;
            this.dataPointMaxWidth &&
                e > n && (e = Math.min(this.dataPointWidth ? this.dataPointWidth : Infinity, n));
            !this.dataPointMaxWidth && (this.dataPointMinWidth && n < e) && (n = Math.max(this.dataPointWidth ? this.dataPointWidth : -Infinity, e));
            r < e && (r = e);
            r > n && (r = n);
            c.save();
            ...
            for (d = 0; d < a.dataSeriesIndexes.length; d++) {
                var n = a.dataSeriesIndexes[d],
                    ...
                    l = m.dataPoints;
                if (0 < l.length)
                    for (var q = 5 < r && m.bevelEnabled ? !0 : !1, e = 0; e < l.length; e++)
                        if (l[e].getTime ? h = l[e].x.getTime() : h = l[e].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && "number" === typeof l[e].y) {
                            ...
                            f = f - a.plotType.totalDataSeries *
                                r / 2 + (a.previousDataSeriesCount + d) * r << 0;
                            var s = f + r << 0,
                                t;
                            0 <= l[e].y ? t = p : (t = g, g = p);
                            g > t && (t = g = t);
                            b = l[e].color ? l[e].color : m._colorSet[e % m._colorSet.length];
                            K(c, f, g, s, t, b, 0, null, q && 0 <= l[e].y, 0 > l[e].y && q, !1, !1, m.fillOpacity);
                            b = m.dataPointIds[e];
                            ...
                            b = F(b);
                            v && K(this._eventManager.ghostCtx, f, g, s, t, b, 0, null, !1, !1, !1, !1);
                            (l[e].indexLabel || m.indexLabel || l[e].indexLabelFormatter || m.indexLabelFormatter) &&
            ...
            return {
                source: c,
                dest: this.plotArea.ctx,
                animationCallback: D.yScaleAnimation,
                easingFunction: D.easing.easeOutQuart,
                animationBase: a
            }
        }
    };
    A.prototype.renderStackedColumn = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null,
                ...
                f = [],
                g = 0,
                h, p = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) << 0,
                ...
                r = a.axisX.dataInfo.minDiff;
            isFinite(r) || (r = 0.3 * Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum));
            r = this.dataPointWidth ? this.dataPointWidth : 0.9 * (d.width / Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum) * Math.abs(r) / a.plotType.plotUnits.length) << 0;
            this.dataPointMaxWidth && g > n && (g = Math.min(this.dataPointWidth ? this.dataPointWidth : Infinity, n));
            !this.dataPointMaxWidth && (this.dataPointMinWidth && n < g) && (n = Math.max(this.dataPointWidth ? this.dataPointWidth : -Infinity, g));
            r < g && (r = g);
            r > n && (r = n);
            c.save();
            v && this._eventManager.ghostCtx.save();
                ...
                if (0 < q.length) {
                    ...
                    for (g = 0; g < q.length; g++)
                        if (b = q[g].x.getTime ? q[g].x.getTime() : q[g].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[g].y) {
                            ...
                            var t = d - a.plotType.plotUnits.length * r / 2 + a.index * r << 0,
                                u = t + r << 0,
                                w;
                            if (0 <= q[g].y) {
                                var z = e[b] ? e[b] : 0;
                                ...
                                w = p - z;
                                e[b] = z + (w - h)
                            } else z = f[b] ? f[b] : 0, w = h + z, h = p + z, f[b] = z + (w - h);
                            b = q[g].color ? q[g].color : l._colorSet[g % l._colorSet.length];
                            K(c, t, h, u, w, b, 0, null, s && 0 <= q[g].y, 0 > q[g].y && s, !1, !1, l.fillOpacity);
                            b = l.dataPointIds[g];
                            this._eventManager.objectMap[b] = {
                                id: b,
                                objectType: "dataPoint",
                            ...
                            b = F(b);
                            v && K(this._eventManager.ghostCtx, t, h, u, w, b, 0, null, !1, !1, !1, !1);
    ...
    A.prototype.renderStackedColumn100 = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            !this.dataPointMaxWidth && (this.dataPointMinWidth &&
                n < g) && (n = Math.max(this.dataPointWidth ? this.dataPointWidth : -Infinity, g));
            r < g && (r = g);
            r > n && (r = n);
            c.save();
            v && this._eventManager.ghostCtx.save();
            ...
            for (n = 0; n < a.dataSeriesIndexes.length; n++) {
                var m = a.dataSeriesIndexes[n],
                    ...
                    q = l.dataPoints;
                if (0 < q.length)
                    for (var s = 5 < r && l.bevelEnabled ? !0 : !1, g = 0; g < q.length; g++)
                        if (b = q[g].x.getTime ? q[g].x.getTime() :
                            ...
                            h = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * ((0 !== a.dataPointYSums[b] ? 100 * (q[g].y / a.dataPointYSums[b]) : 0) - a.axisY.conversionParameters.minimum);
                            var t = d - a.plotType.plotUnits.length * r / 2 + a.index * r << 0,
                                u = t + r << 0,
                                w;
                            if (0 <= q[g].y) {
    ...
    A.prototype.renderBar = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null,
                ...
                r = a.axisX.dataInfo.minDiff;
            isFinite(r) || (r = 0.3 * Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum));
            r = this.dataPointWidth ? this.dataPointWidth : 0.9 * (d.height / Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum) * Math.abs(r) / a.plotType.totalDataSeries) << 0;
            this.dataPointMaxWidth && e > n && (e = Math.min(this.dataPointWidth ? this.dataPointWidth : Infinity, n));
            !this.dataPointMaxWidth && (this.dataPointMinWidth && n < e) && (n = Math.max(this.dataPointWidth ? this.dataPointWidth : -Infinity, e));
            r < e && (r = e);
            r > n && (r = n);
            c.save();
                ...
                if (0 < l.length) {
                    ...
                    for (e = 0; e < l.length; e++)
                        if (l[e].getTime ? h = l[e].x.getTime() : h = l[e].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && "number" === typeof l[e].y) {
                            ...
                            g = g - a.plotType.totalDataSeries * r / 2 + (a.previousDataSeriesCount + d) * r << 0;
                            var s = g + r << 0,
                                t;
                            0 <= l[e].y ? t = p : (t = f, f = p);
                            b = l[e].color ? l[e].color : m._colorSet[e % m._colorSet.length];
                            K(c, t, g, f, s, b, 0, null, q, !1, !1, !1, m.fillOpacity);
                            b = m.dataPointIds[e];
                            this._eventManager.objectMap[b] = {
                                id: b,
                                objectType: "dataPoint",
                            ...
                            b = F(b);
                            v && K(this._eventManager.ghostCtx, t, g, f, s, b, 0, null, !1, !1, !1, !1);
            ...
            return {
                source: c,
                dest: this.plotArea.ctx,
                animationCallback: D.xScaleAnimation,
                easingFunction: D.easing.easeOutQuart,
                animationBase: a
            }
        }
    ...
    A.prototype.renderStackedBar = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null,
                ...
                r = a.axisX.dataInfo.minDiff;
            isFinite(r) || (r = 0.3 * Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum));
            r = this.dataPointWidth ? this.dataPointWidth : 0.9 * (d.height / Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum) * Math.abs(r) / a.plotType.plotUnits.length) << 0;
            this.dataPointMaxWidth && g > n && (g = Math.min(this.dataPointWidth ? this.dataPointWidth : Infinity, n));
            !this.dataPointMaxWidth && (this.dataPointMinWidth && n < g) && (n = Math.max(this.dataPointWidth ? this.dataPointWidth :
                -Infinity, g));
            r < g && (r = g);
            r > n && (r = n);
            c.save();
            ...
            for (n = 0; n < a.dataSeriesIndexes.length; n++) {
                ...
                if (0 < q.length) {
                    ...
                    c.strokeStyle = "#4572A7 ";
                    for (g = 0; g < q.length; g++)
                        if (b = q[g].x.getTime ? q[g].x.getTime() : q[g].x, !(b < a.axisX.dataInfo.viewPortMin ||
                                b > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[g].y) {
                            d = a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit * (b - a.axisX.conversionParameters.minimum) + 0.5 << 0;
                            h = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (q[g].y - a.axisY.conversionParameters.minimum);
                            var t = d - a.plotType.plotUnits.length * r / 2 + a.index * r << 0,
                                u = t + r << 0,
                            ...
                            if (0 <= q[g].y) {
                                ...
                                h += z;
                                e[b] = z + (h - w)
                            } else z = f[b] ? f[b] : 0, w = h - z, h = p - z, f[b] = z + (h - w);
                            b = q[g].color ? q[g].color :
                                l._colorSet[g % l._colorSet.length];
                            K(c, w, t, h, u, b, 0, null, s, !1, !1, !1, l.fillOpacity);
                            b = l.dataPointIds[g];
                            this._eventManager.objectMap[b] = {
                                id: b,
                                objectType: "dataPoint",
                            ...
                            b = F(b);
                            v && K(this._eventManager.ghostCtx, w, t, h, u, b, 0, null, !1, !1, !1, !1);
                            (q[g].indexLabel || l.indexLabel || q[g].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({
    ...
    A.prototype.renderStackedBar100 = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null,
                ...
                f = [],
                g = 0,
                h, p = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit *
                ...
                r = a.axisX.dataInfo.minDiff;
            isFinite(r) || (r = 0.3 * Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum));
            r = this.dataPointWidth ? this.dataPointWidth : 0.9 * (d.height / Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum) * Math.abs(r) / a.plotType.plotUnits.length) <<
                0;
            this.dataPointMaxWidth && g > n && (g = Math.min(this.dataPointWidth ? this.dataPointWidth : Infinity, n));
            !this.dataPointMaxWidth && (this.dataPointMinWidth && n < g) && (n = Math.max(this.dataPointWidth ? this.dataPointWidth : -Infinity, g));
            r < g && (r = g);
            ...
            for (n = 0; n < a.dataSeriesIndexes.length; n++) {
                ...
                if (0 < q.length) {
                    ...
                    for (g = 0; g < q.length; g++)
                        if (b = q[g].x.getTime ? q[g].x.getTime() : q[g].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[g].y) {
                            d = a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit * (b - a.axisX.conversionParameters.minimum) + 0.5 << 0;
                            h = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * ((0 !== a.dataPointYSums[b] ?
                                100 * (q[g].y / a.dataPointYSums[b]) : 0) - a.axisY.conversionParameters.minimum);
                            var t = d - a.plotType.plotUnits.length * r / 2 + a.index * r << 0,
                                u = t + r << 0,
                                w;
                            if (0 <= q[g].y) {
                            ...
                            b = F(b);
                            v && K(this._eventManager.ghostCtx,
                                w, t, h, u, b, 0, null, !1, !1, !1, !1);
                            (q[g].indexLabel || l.indexLabel || q[g].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({
    ...
    A.prototype.renderArea = function(a) {
        function c() {
            z && (0 < n.lineThickness && b.stroke(), 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? w = u : 0 > a.axisY.viewportMaximum ? w = f.y1 : 0 < a.axisY.viewportMinimum && (w = e.y2), b.lineTo(q, w), b.lineTo(z.x, w), b.closePath(), b.globalAlpha = n.fillOpacity, b.fill(), b.globalAlpha = 1, v && (d.lineTo(q, w), d.lineTo(z.x, w), d.closePath(), d.fill()), b.beginPath(), b.moveTo(q, s), d.beginPath(), d.moveTo(q, s), z = {
                x: q,
                y: s
            })
        }
        ...
        if (!(0 >=
            ...
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                var g = [],
                    m = !0,
                    l = 0,
                    q, s, t, u = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) + 0.5 << 0,
                    w, z = null;
                if (0 < r.length) {
                    var x = n._colorSet[l % n._colorSet.length];
                    b.fillStyle = x;
                    b.strokeStyle = x;
                    b.lineWidth = n.lineThickness;
                    b.setLineDash && b.setLineDash(G(n.lineDashType, n.lineThickness));
                    for (var y = !0; l < r.length; l++)
                        if (t = r[l].x.getTime ? r[l].x.getTime() : r[l].x, !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax))
                            if ("number" !== typeof r[l].y) c(), y = !0;
                            else {
                                q =
                                    a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit * (t - a.axisX.conversionParameters.minimum) + 0.5 << 0;
                                s = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (r[l].y - a.axisY.conversionParameters.minimum) + 0.5 << 0;
                                m || y ? (b.beginPath(), b.moveTo(q, s), z = {
                                    x: q,
                                    y: s
                                }, v && (d.beginPath(), d.moveTo(q, s)), y = m = !1) : (b.lineTo(q, s), v && d.lineTo(q, s), 0 == l % 250 && c());
                                var H = n.dataPointIds[l];
                                ...
                                0 !== r[l].markerSize && (0 < r[l].markerSize || 0 < n.markerSize) && (t = n.getMarkerProperties(l, q, s, b), g.push(t), H = F(H), v && g.push({
                                    x: q,
                                    y: s,
                                    ctx: d,
                                    type: t.type,
                                ...
                                (r[l].indexLabel || n.indexLabel || r[l].indexLabelFormatter || n.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: "area",
                                    dataPoint: r[l],
                                    dataSeries: n,
                                    point: {
    ...
    A.prototype.renderSplineArea = function(a) {
        function c() {
            ...
            if (0 < c.length) {
                ...
                0 >= a.axisY.viewportMinimum &&
                    0 <= a.axisY.viewportMaximum ? t = s : 0 > a.axisY.viewportMaximum ? t = f.y1 : 0 < a.axisY.viewportMinimum && (t = e.y2);
                u = {
                    x: c[0].x,
                    y: c[0].y
                };
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                var g = [],
                    m = 0,
                    l, q, s = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) + 0.5 << 0,
                    t, u = null,
                    w = [];
                if (0 <
                    r.length) {
                    color = n._colorSet[m % n._colorSet.length];
                    b.fillStyle = color;
                    b.strokeStyle = color;
                    b.lineWidth = n.lineThickness;
                    for (b.setLineDash && b.setLineDash(G(n.lineDashType, n.lineThickness)); m < r.length; m++)
                        if (l = r[m].x.getTime ? r[m].x.getTime() : r[m].x, !(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax))
                            if ("number" !== typeof r[m].y) 0 < m && (c(), w = []);
                            else {
                                ...
                                q = a.axisY.conversionParameters.reference +
                                    a.axisY.conversionParameters.pixelPerUnit * (r[m].y - a.axisY.conversionParameters.minimum) + 0.5 << 0;
                                var z = n.dataPointIds[m];
                                this._eventManager.objectMap[z] = {
                                    id: z,
                                    objectType: "dataPoint",
                                    dataSeriesIndex: p,
                                ...
                                if (0 !== r[m].markerSize && (0 < r[m].markerSize || 0 < n.markerSize)) {
                                    var x = n.getMarkerProperties(m, l, q, b);
                                    g.push(x);
                                    z = F(z);
                                    v && g.push({
                                        x: l,
                                ...
                                }(r[m].indexLabel || n.indexLabel ||
                                    r[m].indexLabelFormatter || n.indexLabelFormatter) && this._indexLabels.push({
    ...
    A.prototype.renderStepArea = function(a) {
        function c() {
            z && (0 < n.lineThickness && b.stroke(), 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ?
                w = u : 0 > a.axisY.viewportMaximum ? w = f.y1 : 0 < a.axisY.viewportMinimum && (w = e.y2), b.lineTo(q, w), b.lineTo(z.x, w), b.closePath(), b.globalAlpha = n.fillOpacity, b.fill(), b.globalAlpha = 1, v && (d.lineTo(q, w), d.lineTo(z.x, w), d.closePath(), d.fill()), b.beginPath(), b.moveTo(q, s), d.beginPath(), d.moveTo(q, s), z = {
                    x: q,
                    y: s
                })
        }
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                if (0 < r.length) {
                    var y =
                        n._colorSet[l % n._colorSet.length];
                    b.fillStyle = y;
                    b.strokeStyle = y;
                    b.lineWidth = n.lineThickness;
                    for (b.setLineDash && b.setLineDash(G(n.lineDashType, n.lineThickness)); l < r.length; l++)
                        if (t = r[l].x.getTime ? r[l].x.getTime() : r[l].x, !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax)) {
                            var H = s;
                            "number" !== typeof r[l].y ? (c(), x = !0) : (q = a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit * (t - a.axisX.conversionParameters.minimum) + 0.5 << 0, s = a.axisY.conversionParameters.reference +
                                a.axisY.conversionParameters.pixelPerUnit * (r[l].y - a.axisY.conversionParameters.minimum) + 0.5 << 0, m || x ? (b.beginPath(), b.moveTo(q, s), z = {
                                    x: q,
                                    y: s
                                }, v && (d.beginPath(), d.moveTo(q, s)), x = m = !1) : (b.lineTo(q, H), v && d.lineTo(q, H), b.lineTo(q, s), v && d.lineTo(q, s), 0 == l % 250 && c()), H = n.dataPointIds[l], this._eventManager.objectMap[H] = {
                                    id: H,
                                    objectType: "dataPoint",
                                    dataSeriesIndex: p,
                                    dataPointIndex: l,
        ...
        function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null,
                    ...
                    g = [],
                    h = 0,
                    p, n, r, m = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) << 0,
                ...
                c.clip();
                v && (l.beginPath(), l.rect(e.x1, e.y1, e.width, e.height), l.clip());
                xValuePresent = [];
                for (e = 0; e < a.dataSeriesIndexes.length; e++) {
                    var q =
                        ...
                        t = s.dataPoints;
                    s.dataPointIndexes = [];
                    for (h = 0; h < t.length; h++) q = t[h].x.getTime ? t[h].x.getTime() : t[h].x, s.dataPointIndexes[q] = h, xValuePresent[q] || (g.push(q), xValuePresent[q] = !0);
                    g.sort(ua)
                }
                for (e = 0; e < a.dataSeriesIndexes.length; e++) {
                    ...
                    if (0 < g.length) {
                        ...
                        c.setLineDash && c.setLineDash(G(s.lineDashType, s.lineThickness));
                        for (h = 0; h < g.length; h++) {
                            r = g[h];
                            var z = null,
                                z = 0 <= s.dataPointIndexes[r] ? t[s.dataPointIndexes[r]] : {
                                    x: r,
                                    y: 0
                                };
                            if (!(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax) && "number" === typeof z.y) {
                                p = a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit * (r - a.axisX.conversionParameters.minimum) + 0.5 << 0;
                                n = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit *
                                    (z.y - a.axisY.conversionParameters.minimum);
                                var x = f[r] ? f[r] : 0;
                                n -= x;
                                w.push({
                                    x: p,
                                ...
                                f[r] = m - n;
                                if (u) c.beginPath(), c.moveTo(p, n), v && (l.beginPath(), l.moveTo(p, n)), u = !1;
                                else if (c.lineTo(p, n), v && l.lineTo(p, n), 0 == h % 250) {
                                    for (0 < s.lineThickness && c.stroke(); 0 < w.length;) {
                                        var y = w.pop();
                                        c.lineTo(y.x, y.y);
                                        v && l.lineTo(y.x, y.y)
                                    }
                                    ...
                                    c.beginPath();
                                    c.moveTo(p, n);
                                    v && (l.closePath(), l.fill(), l.beginPath(), l.moveTo(p, n));
                                    w.push({
                                        x: p,
                                        y: m - x
                                    })
                                }
                                if (0 <= s.dataPointIndexes[r]) {
                                    var H =
                                        s.dataPointIds[s.dataPointIndexes[r]];
                                    this._eventManager.objectMap[H] = {
                                        id: H,
                                        objectType: "dataPoint",
                                        dataSeriesIndex: q,
                                        dataPointIndex: s.dataPointIndexes[r],
                                        x1: p,
                                        y1: n
                                    }
                                }
                                0 <= s.dataPointIndexes[r] && 0 !== z.markerSize && (0 < z.markerSize || 0 < s.markerSize) && (r = s.getMarkerProperties(h, p, n, c), d.push(r), markerColor = F(H), v && d.push({
                                    x: p,
                                    y: n,
                                    ctx: l,
                                    type: r.type,
                                ...
                                (z.indexLabel || s.indexLabel || z.indexLabelFormatter || s.indexLabelFormatter) &&
                                this._indexLabels.push({
                                    ...
                                    direction: 0 <= t[h].y ? 1 : -1,
                                    color: b
                                })
                            }
                        }
                        for (0 < s.lineThickness && c.stroke(); 0 < w.length;) y = w.pop(), c.lineTo(y.x, y.y), v && l.lineTo(y.x, y.y);
                        c.closePath();
                        c.globalAlpha = s.fillOpacity;
                        c.fill();
                        c.globalAlpha = 1;
    ...
    A.prototype.renderStackedArea100 = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null,
                ...
                q = 0.9 * d.width / Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum) *
                Math.abs(q) << 0,
            ...
            c.rect(d.x1, d.y1, d.width, d.height);
            c.clip();
            v && (s.beginPath(), s.rect(d.x1, d.y1, d.width, d.height), s.clip());
            xValuePresent = [];
            for (d = 0; d < a.dataSeriesIndexes.length; d++) {
                var t = a.dataSeriesIndexes[d],
                    ...
                    w = u.dataPoints;
                u.dataPointIndexes = [];
                for (h = 0; h < w.length; h++) t = w[h].x.getTime ? w[h].x.getTime() : w[h].x, u.dataPointIndexes[t] = h, xValuePresent[t] || (g.push(t), xValuePresent[t] = !0);
                g.sort(ua)
            }
            for (d = 0; d < a.dataSeriesIndexes.length; d++) {
                var t =
                ...
                var x = [];
                if (0 < g.length) {
                    b = u._colorSet[h % u._colorSet.length];
                    c.fillStyle = b;
                    c.strokeStyle = b;
                    c.lineWidth = u.lineThickness;
                    c.setLineDash && c.setLineDash(G(u.lineDashType, u.lineThickness));
                    for (h = 0; h < g.length; h++) {
                        r = g[h];
                        var y = null,
                            y = 0 <= u.dataPointIndexes[r] ? w[u.dataPointIndexes[r]] : {
                                x: r,
                                y: 0
                            };
                        if (!(r < a.axisX.dataInfo.viewPortMin ||
                                r > a.axisX.dataInfo.viewPortMax) && "number" === typeof y.y) {
                            n = 0 !== a.dataPointYSums[r] ? 100 * (y.y / a.dataPointYSums[r]) : 0;
                            p = a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit * (r - a.axisX.conversionParameters.minimum) + 0.5 << 0;
                            n = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (n - a.axisY.conversionParameters.minimum);
                            var H = f[r] ? f[r] : 0;
                            n -= H;
                            x.push({
                                x: p,
                            ...
                            f[r] = m - n;
                            if (z) c.beginPath(), c.moveTo(p, n), v && (s.beginPath(), s.moveTo(p, n)), z = !1;
                            else if (c.lineTo(p,
                                    n), v && s.lineTo(p, n), 0 == h % 250) {
                                for (0 < u.lineThickness && c.stroke(); 0 < x.length;) {
                                    var B = x.pop();
                                    c.lineTo(B.x, B.y);
                                    v && s.lineTo(B.x, B.y)
                                }
                                ...
                                c.beginPath();
                                c.moveTo(p, n);
                                v && (s.closePath(), s.fill(), s.beginPath(), s.moveTo(p, n));
                                x.push({
                                    x: p,
                                    y: m - H
                                })
                            }
                            if (0 <= u.dataPointIndexes[r]) {
                                var A = u.dataPointIds[u.dataPointIndexes[r]];
                                this._eventManager.objectMap[A] = {
                                    id: A,
                                    objectType: "dataPoint",
                                    dataSeriesIndex: t,
                                    dataPointIndex: u.dataPointIndexes[r],
                                    x1: p,
                                    y1: n
                                }
                            }
                            0 <=
                                u.dataPointIndexes[r] && 0 !== y.markerSize && (0 < y.markerSize || 0 < u.markerSize) && (r = u.getMarkerProperties(h, p, n, c), e.push(r), markerColor = F(A), v && e.push({
                                    x: p,
                                    y: n,
                                    ctx: s,
                                    type: r.type,
                            ...
                            (y.indexLabel || u.indexLabel || y.indexLabelFormatter || u.indexLabelFormatter) && this._indexLabels.push({
                                ...
                                direction: 0 <= w[h].y ? 1 : -1,
                                color: b
                            })
                        }
                    }
                    for (0 < u.lineThickness && c.stroke(); 0 <
                        x.length;) B = x.pop(), c.lineTo(B.x, B.y), v && s.lineTo(B.x, B.y);
                    c.closePath();
                    c.globalAlpha = u.fillOpacity;
                    c.fill();
                    c.globalAlpha = 1;
    ...
    A.prototype.renderBubble = function(a) {
        ...
        if (!(0 >= b)) {
            var d = this.plotArea,
                e = 0,
                f, g, h = this.dataPointMaxWidth ? this.dataPointMaxWidth : 0.15 * this.width << 0,
            ...
            c.clip();
            v && (this._eventManager.ghostCtx.rect(d.x1, d.y1, d.width, d.height), this._eventManager.ghostCtx.clip());
            for (var p = -Infinity, n = Infinity, r = 0; r < a.dataSeriesIndexes.length; r++)
                for (var m =
                        a.dataSeriesIndexes[r], l = this.data[m], q = l.dataPoints, s = 0, e = 0; e < q.length; e++) f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || "undefined" === typeof q[e].z || (s = q[e].z, s > p && (p = s), s < n && (n = s));
            for (var t = 25 * Math.PI, d = Math.max(Math.pow(0.25 * Math.min(d.height, d.width) / 2, 2) * Math.PI, t), r = 0; r < a.dataSeriesIndexes.length; r++)
                if (m = a.dataSeriesIndexes[r], l = this.data[m], q = l.dataPoints, 1 == q.length && (b = h), 1 > b ? b = 1 : b > h && (b = h), 0 < q.length)
                    for (c.strokeStyle = "#4572A7 ",
                        ...
                        if (f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[e].y) {
                            ...
                            var s = q[e].z,
                                u = 2 * Math.max(Math.sqrt((p === n ? d / 2 : t + (d - t) / (p - n) * (s - n)) / Math.PI) <<
                                    0, 1),
                                s = l.getMarkerProperties(e, c);
                            s.size = u;
                            c.globalAlpha = l.fillOpacity;
                            N.drawMarker(f, g, c, s.type, s.size, s.color, s.borderColor, s.borderThickness);
                            c.globalAlpha = 1;
                            var w = l.dataPointIds[e];
                            ...
                            u = F(w);
                            v && N.drawMarker(f, g, this._eventManager.ghostCtx, s.type, s.size, u, u, s.borderThickness);
    ...
    A.prototype.renderScatter = function(a) {
        ...
        if (!(0 >= b)) {
            var d = this.plotArea,
                e = 0,
                f, g, h = this.dataPointMaxWidth ? this.dataPointMaxWidth :
                0.15 * this.width << 0,
                e = a.axisX.dataInfo.minDiff,
                b = 0.9 * (d.width / Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum) * Math.abs(e) / b) << 0;
            c.save();
                ...
                if (0 < m.length) {
                    ...
                    for (var l = 0, q = 0, e = 0; e < m.length; e++)
                        if (f = m[e].getTime ? f = m[e].x.getTime() : f = m[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof m[e].y) {
                            ...
                            var s =
                                r.getMarkerProperties(e, f, g, c);
                            c.globalAlpha = r.fillOpacity;
                            N.drawMarker(s.x, s.y, s.ctx, s.type, s.size, s.color, s.borderColor, s.borderThickness);
                            c.globalAlpha = 1;
                            Math.sqrt((l - f) * (l - f) + (q - g) * (q - g)) < Math.min(s.size, 5) && m.length > Math.min(this.plotArea.width, this.plotArea.height) || (l = r.dataPointIds[e], this._eventManager.objectMap[l] = {
                                id: l,
                                objectType: "dataPoint",
                                dataSeriesIndex: n,
                                dataPointIndex: e,
                                x1: f,
                                y1: g
                            }, l = F(l), v && N.drawMarker(s.x, s.y, this._eventManager.ghostCtx, s.type, s.size, l, l, s.borderThickness), (m[e].indexLabel ||
                                r.indexLabel || m[e].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({
                                chartType: "scatter",
                                dataPoint: m[e],
                                dataSeries: r,
                                point: {
    ...
    A.prototype.renderCandlestick = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var d = null,
                d = this.plotArea,
                e = 0,
                f, g, h, p, n, r, e = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1;
            ...
            m = this.dataPointWidth ? this.dataPointWidth : 0.7 * d.width / Math.abs(a.axisX.viewportMaximum -
                a.axisX.viewportMinimum) * Math.abs(m) << 0;
            ...
            c.rect(d.x1, d.y1, d.width, d.height);
            c.clip();
            v && (b.rect(d.x1, d.y1, d.width, d.height), b.clip());
            for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
                var q = a.dataSeriesIndexes[l],
                    s = this.data[q],
                    t = s.dataPoints;
                if (0 < t.length)
                    for (var u = 5 < m && s.bevelEnabled ? !0 : !1, e = 0; e < t.length; e++)
                        if (t[e].getTime ? r = t[e].x.getTime() : r = t[e].x, !(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax) && null !== t[e].y && t[e].y.length && "number" === typeof t[e].y[0] && "number" === typeof t[e].y[1] && "number" === typeof t[e].y[2] && "number" === typeof t[e].y[3]) {
                            f = a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit * (r - a.axisX.conversionParameters.minimum) + 0.5 << 0;
                            g = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit *
                                (t[e].y[0] - a.axisY.conversionParameters.minimum) + 0.5 << 0;
                            ...
                            p = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (t[e].y[2] - a.axisY.conversionParameters.minimum) + 0.5 << 0;
                            n = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (t[e].y[3] - a.axisY.conversionParameters.minimum) + 0.5 << 0;
                            var w = f - m / 2 << 0,
                                z = w + m << 0,
                                d = t[e].color ?
                                t[e].color : s._colorSet[0],
                                x = Math.round(Math.max(1, 0.15 * m)),
                                y = 0 === x % 2 ? 0 : 0.5,
                                B = s.dataPointIds[e];
                            this._eventManager.objectMap[B] = {
                                id: B,
                            ...
                            "candlestick" === s.type ? (c.moveTo(f - y, h), c.lineTo(f - y, Math.min(g, n)), c.stroke(), c.moveTo(f - y, Math.max(g, n)), c.lineTo(f - y, p), c.stroke(), K(c, w, Math.min(g, n), z, Math.max(g, n), t[e].y[0] <=
                                ...
                                b.moveTo(f, g), b.lineTo(w, g), b.stroke(), b.beginPath(), b.moveTo(f, n), b.lineTo(z, n), b.stroke()));
                            (t[e].indexLabel || s.indexLabel || t[e].indexLabelFormatter || s.indexLabelFormatter) && this._indexLabels.push({
                                chartType: s.type,
                                dataPoint: t[e],
                                dataSeries: s,
                                point: {
    ...
    A.prototype.renderRangeColumn = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            h = this.dataPointWidth ? this.dataPointWidth :
                0.9 * (d.width / Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum) * Math.abs(h) / a.plotType.totalDataSeries) << 0;
            this.dataPointMaxWidth && e > f && (e = Math.min(this.dataPointWidth ? this.dataPointWidth : Infinity, f));
            !this.dataPointMaxWidth && (this.dataPointMinWidth && f < e) && (f = Math.max(this.dataPointWidth ? this.dataPointWidth : -Infinity, e));
            h < e && (h = e);
            h > f && (h = f);
            ...
            c.rect(d.x1, d.y1, d.width, d.height);
            c.clip();
            v && (this._eventManager.ghostCtx.rect(d.x1, d.y1,
            ...
            for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                var n = a.dataSeriesIndexes[p],
                    ...
                    m = r.dataPoints;
                if (0 < m.length)
                    for (var l = 5 < h && r.bevelEnabled ? !0 : !1, e = 0; e < m.length; e++)
                        if (m[e].getTime ? g = m[e].x.getTime() : g = m[e].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && null !== m[e].y && m[e].y.length && "number" === typeof m[e].y[0] && "number" === typeof m[e].y[1]) {
                            b = a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit *
                            ...
                            var q = b - a.plotType.totalDataSeries * h / 2 + (a.previousDataSeriesCount + p) * h << 0,
                                s = q + h << 0,
                            ...
                            K(c, q, d, s, f, b, 0, b, l, l, !1, !1, r.fillOpacity);
                            b = F(t);
                            v && K(this._eventManager.ghostCtx, q, d, s, f, b, 0, null, !1, !1, !1, !1);
                            if (m[e].indexLabel || r.indexLabel || m[e].indexLabelFormatter || r.indexLabelFormatter) this._indexLabels.push({
    ...
    A.prototype.renderRangeBar = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            p = this.dataPointWidth ?
                this.dataPointWidth : 0.9 * (d.height / Math.abs(a.axisX.viewportMaximum - a.axisX.viewportMinimum) * Math.abs(p) / a.plotType.totalDataSeries) << 0;
            this.dataPointMaxWidth && e > f && (e = Math.min(this.dataPointWidth ? this.dataPointWidth : Infinity, f));
            !this.dataPointMaxWidth && (this.dataPointMinWidth && f < e) && (f = Math.max(this.dataPointWidth ? this.dataPointWidth : -Infinity, e));
            p < e && (p = e);
            p > f && (p = f);
                ...
                if (0 < l.length) {
                    ...
                    for (e = 0; e < l.length; e++)
                        if (l[e].getTime ? h = l[e].x.getTime() : h = l[e].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && null !== l[e].y && l[e].y.length && "number" === typeof l[e].y[0] && "number" === typeof l[e].y[1]) {
                            d = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit *
                                (l[e].y[0] - a.axisY.conversionParameters.minimum) + 0.5 << 0;
                            ...
                            g = g - a.plotType.totalDataSeries * p / 2 + (a.previousDataSeriesCount + n) * p << 0;
                            var s = g + p << 0;
                            d > f && (b = d, d = f, f = b);
                            b = l[e].color ? l[e].color : m._colorSet[e % m._colorSet.length];
                            K(c, d, g, f, s, b, 0,
                            ...
                            b = F(b);
                            v && K(this._eventManager.ghostCtx, d, g, f, s, b, 0, null, !1, !1, !1, !1);
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                var e = [],
                    ...
                    l, q, s, t, u = null;
                if (0 < n.length) {
                    var w = p._colorSet[m % p._colorSet.length];
                    b.fillStyle = w;
                    b.strokeStyle = w;
                    b.lineWidth =
                        p.lineThickness;
                    b.setLineDash && b.setLineDash(G(p.lineDashType, p.lineThickness));
                    for (var z = !0; m < n.length; m++)
                        if (t = n[m].x.getTime ? n[m].x.getTime() : n[m].x, !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax))
                            if (null !== n[m].y && n[m].y.length && "number" === typeof n[m].y[0] && "number" === typeof n[m].y[1]) {
                                ...
                                q = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit *
                                    (n[m].y[0] - a.axisY.conversionParameters.minimum) + 0.5 << 0;
                                s = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (n[m].y[1] - a.axisY.conversionParameters.minimum) + 0.5 << 0;
                                r || z ? (b.beginPath(), b.moveTo(l, q), u = {
                                    x: l,
                                    y: q
                                }, g = [], g.push({
                                    x: l,
                                    y: s
                                }), v && (d.beginPath(), d.moveTo(l, q)), z = r = !1) : (b.lineTo(l, q), g.push({
                                    x: l,
                                    y: s
                                }), v && d.lineTo(l, q), 0 == m % 250 && c());
                                t = p.dataPointIds[m];
                                this._eventManager.objectMap[t] = {
                                    id: t,
                                    objectType: "dataPoint",
                                ...
                                if (0 !== n[m].markerSize && (0 < n[m].markerSize || 0 < p.markerSize)) {
                                    var x = p.getMarkerProperties(m, l, s, b);
                                    e.push(x);
                                    var y = F(t);
                                    v && e.push({
                                        x: l,
                                    ...
                                    x = p.getMarkerProperties(m, l, q, b);
                                    e.push(x);
                                    y = F(t);
                                    v && e.push({
                                        x: l,
                                ...
                                if (n[m].indexLabel || p.indexLabel || n[m].indexLabelFormatter || p.indexLabelFormatter) this._indexLabels.push({
                                    chartType: "rangeArea",
                                    dataPoint: n[m],
                                    dataSeries: p,
                                    indexKeyword: 0,
    ...
    A.prototype.renderRangeSplineArea =
        function(a) {
            function c() {
                var a = ia(q, 2);
                if (0 < a.length) {
                    ...
                    for (var c = 0; c < a.length - 3; c += 3) b.bezierCurveTo(a[c + 1].x, a[c + 1].y, a[c + 2].x, a[c + 2].y, a[c + 3].x, a[c + 3].y), v && d.bezierCurveTo(a[c + 1].x, a[c + 1].y, a[c + 2].x, a[c + 2].y, a[c + 3].x, a[c + 3].y);
                    0 < h.lineThickness && b.stroke();
                    a = ia(s, 2);
                    b.lineTo(s[s.length - 1].x, s[s.length - 1].y);
                    for (c = a.length - 1; 2 < c; c -= 3) b.bezierCurveTo(a[c - 1].x, a[c - 1].y, a[c - 2].x, a[c - 2].y, a[c - 3].x, a[c - 3].y), v && d.bezierCurveTo(a[c -
                        1].x, a[c - 1].y, a[c - 2].x, a[c - 2].y, a[c - 3].x, a[c - 3].y);
                    b.closePath();
                    ...
                    if (0 < h.lineThickness) {
                        b.beginPath();
                        b.moveTo(s[s.length - 1].x, s[s.length - 1].y);
                        for (c = a.length - 1; 2 < c; c -= 3) b.bezierCurveTo(a[c - 1].x, a[c - 1].y, a[c - 2].x, a[c - 2].y, a[c - 3].x, a[c - 3].y), v && d.bezierCurveTo(a[c - 1].x, a[c - 1].y, a[c - 2].x, a[c - 2].y, a[c - 3].x, a[c - 3].y);
                        b.stroke()
                    }
                    b.beginPath();
                ...
                for (f = 0; f < a.dataSeriesIndexes.length; f++) {
                    ...
                    if (0 < p.length) {
                        ...
                        b.strokeStyle =
                            color;
                        b.lineWidth = h.lineThickness;
                        for (b.setLineDash && b.setLineDash(G(h.lineDashType, h.lineThickness)); n < p.length; n++)
                            if (r = p[n].x.getTime ? p[n].x.getTime() : p[n].x, !(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax))
                                if (null !== p[n].y && p[n].y.length && "number" === typeof p[n].y[0] && "number" === typeof p[n].y[1]) {
                                    ...
                                    m = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit *
                                        (p[n].y[0] - a.axisY.conversionParameters.minimum) + 0.5 << 0;
                                    l = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (p[n].y[1] - a.axisY.conversionParameters.minimum) + 0.5 << 0;
                                    var t = h.dataPointIds[n];
                                    this._eventManager.objectMap[t] = {
                                        id: t,
                                        objectType: "dataPoint",
                                        dataSeriesIndex: g,
                                    ...
                                    if (0 !== p[n].markerSize && (0 < p[n].markerSize || 0 < h.markerSize)) {
                                        var u = h.getMarkerProperties(n, r, m, b);
                                        e.push(u);
                                        var w = F(t);
                                        v && e.push({
                                            x: r,
                                        ...
                                        u = h.getMarkerProperties(n, r, l, b);
                                        e.push(u);
                                        w = F(t);
                                        v && e.push({
                                            x: r,
    ...
    var sa = function(a, c, b, d, e, f, g, h, p) {
        if (!(0 > b)) {
            "undefined" === typeof h && (h = 1);
            if (!v) {
                var n = Number((g % (2 * Math.PI)).toFixed(8));
                Number((f % (2 * Math.PI)).toFixed(8)) === n && (g -=
                    1E-4)
            }
            a.save();
            a.globalAlpha = h;
    ...
    A.prototype.renderPie = function(a) {
            ...
            if (n && r) {
                ...
                for (y = 0; y < r.length; y++) {
                    ...
                    var h = {
                        ...
                        m = null,
                        h = p.getPercentAndTotal(n, e);
                    if (n.indexLabelFormatter || e.indexLabelFormatter) m = {
                        chart: p._options,
                        dataSeries: n,
                        dataPoint: e,
                        total: h.total,
                    ...
                    h = e.indexLabelFormatter ? e.indexLabelFormatter(m) : e.indexLabel ? p.replaceKeywordsWithValue(e.indexLabel, e, n, y) : n.indexLabelFormatter ? n.indexLabelFormatter(m) : n.indexLabel ? p.replaceKeywordsWithValue(n.indexLabel, e, n, y) : e.label ? e.label : "";
                    p._eventManager.objectMap[f] =
                        g;
                    g.center = {
                        x: v.x,
                        y: v.y
                    ...
                    g.y = e.y;
                    g.radius = A;
                    g.percentInnerRadius = F;
                    g.indexLabelText = h;
                    g.indexLabelPlacement = n.indexLabelPlacement;
                    g.indexLabelLineColor = e.indexLabelLineColor ? e.indexLabelLineColor : n.indexLabelLineColor ? n.indexLabelLineColor : e.color ? e.color : n._colorSet[y % n._colorSet.length];
                    g.indexLabelLineThickness = B(e.indexLabelLineThickness) ? n.indexLabelLineThickness : e.indexLabelLineThickness;
                    g.indexLabelLineDashType = e.indexLabelLineDashType ? e.indexLabelLineDashType : n.indexLabelLineDashType;
                    g.indexLabelFontColor =
                        e.indexLabelFontColor ? e.indexLabelFontColor : n.indexLabelFontColor;
                    g.indexLabelFontStyle = e.indexLabelFontStyle ? e.indexLabelFontStyle : n.indexLabelFontStyle;
                    g.indexLabelFontWeight = e.indexLabelFontWeight ? e.indexLabelFontWeight : n.indexLabelFontWeight;
                    g.indexLabelFontSize = e.indexLabelFontSize ? e.indexLabelFontSize : n.indexLabelFontSize;
                    g.indexLabelFontFamily = e.indexLabelFontFamily ? e.indexLabelFontFamily : n.indexLabelFontFamily;
                    g.indexLabelBackgroundColor = e.indexLabelBackgroundColor ? e.indexLabelBackgroundColor :
                        n.indexLabelBackgroundColor ? n.indexLabelBackgroundColor : null;
                    g.indexLabelMaxWidth = e.indexLabelMaxWidth ? e.indexLabelMaxWidth : n.indexLabelMaxWidth ? n.indexLabelMaxWidth : 0.33 * l.width;
                    g.indexLabelWrap = "undefined" !== typeof e.indexLabelWrap ? e.indexLabelWrap : n.indexLabelWrap;
                    g.startAngle = 0 === y ? n.startAngle ? n.startAngle / 180 * Math.PI : 0 : q[y - 1].endAngle;
                    g.startAngle = (g.startAngle + 2 * Math.PI) % (2 * Math.PI);
                    g.endAngle = g.startAngle + 2 * Math.PI / x * Math.abs(e.y);
                    ...
                    g.indexLabelTextBlock = new M(p.plotArea.ctx, {
                ...
                f = e = 0;
                h = !1;
                for (y = 0; y < r.length; y++) g = q[(c + y) % r.length], 1 < a && (g.midAngle > Math.PI / 2 - u && g.midAngle < Math.PI / 2 + u) && (e <= a / 2 && !h ? (g.hemisphere = "right", e++) : (g.hemisphere = "left", h = !0));
                h = !1;
                for (y = 0; y < r.length; y++) g = q[(d + y) % r.length], 1 < b && (g.midAngle > 3 * Math.PI / 2 - u && g.midAngle < 3 * Math.PI / 2 + u) && (f <= b / 2 && !h ? (g.hemisphere =
                    "left", f++) : (g.hemisphere = "right", h = !0))
            }
        }
        ...
        function b(a) {
            ...
            for (b = 0; b < r.length; b++) {
                ...
                if (d > c) {
                    var e = 0.07 * A * Math.cos(q[b].midAngle),
                        ...
                        g = !1;
                    if (r[b].exploded) {
                        if (1E-9 < Math.abs(q[b].center.x - (v.x + e)) || 1E-9 < Math.abs(q[b].center.y - (v.y + f))) q[b].center.x = v.x + e * a, q[b].center.y = v.y + f * a, g = !0
                    } else if (0 < Math.abs(q[b].center.x -
                            v.x) || 0 < Math.abs(q[b].center.y - v.y)) q[b].center.x = v.x + e * (1 - a), q[b].center.y = v.y + f * (1 - a), g = !0;
                    g && (e = {}, e.dataSeries = n, e.dataPoint = n.dataPoints[b], e.index = b, p._toolTip.highlightObjects([e]));
                    sa(p.plotArea.ctx, q[b].center, q[b].radius, r[b].color ? r[b].color : n._colorSet[b % n._colorSet.length], n.type, c, d, n.fillOpacity, q[b].percentInnerRadius)
                }
            }
            a = p.plotArea.ctx;
            a.save();
            ...
            a.lineJoin = "round";
            for (b = b = 0; b < r.length; b++) c = q[b], c.indexLabelText && (c.indexLabelTextBlock.y -=
                c.indexLabelTextBlock.height / 2, d = 0, d = "left" === c.hemisphere ? "inside" !== n.indexLabelPlacement ? -(c.indexLabelTextBlock.width + m) : -c.indexLabelTextBlock.width / 2 : "inside" !== n.indexLabelPlacement ? m : -c.indexLabelTextBlock.width / 2, c.indexLabelTextBlock.x += d, c.indexLabelTextBlock.render(!0), c.indexLabelTextBlock.x -= d, c.indexLabelTextBlock.y += c.indexLabelTextBlock.height / 2, "inside" !== c.indexLabelPlacement && 0 < c.indexLabelLineThickness && (d = c.center.x + A * Math.cos(c.midAngle), e = c.center.y + A * Math.sin(c.midAngle),
                    a.strokeStyle = c.indexLabelLineColor, a.lineWidth = c.indexLabelLineThickness, a.setLineDash && a.setLineDash(G(c.indexLabelLineDashType, c.indexLabelLineThickness)), a.beginPath(), a.moveTo(d, e), a.lineTo(c.indexLabelTextBlock.x, c.indexLabelTextBlock.y), a.lineTo(c.indexLabelTextBlock.x + ("left" === c.hemisphere ? -m : m), c.indexLabelTextBlock.y), a.stroke()), a.lineJoin = "miter");
            a.save()
        }
        ...
        function f(a, b, c) {
            ...
            b = b || 0;
            var g = 0,
                h = v.y - 1 * indexLabelRadius,
                m = v.y + 1 * indexLabelRadius;
            if (0 <= a && a < r.length) {
                var l = q[a];
                ...
                0 > b ? l.indexLabelTextBlock.y - l.indexLabelTextBlock.height / 2 > h && l.indexLabelTextBlock.y - l.indexLabelTextBlock.height / 2 + b < h && (b = -(h - (l.indexLabelTextBlock.y - l.indexLabelTextBlock.height / 2 + b))) : l.indexLabelTextBlock.y + l.indexLabelTextBlock.height /
                    2 < h && l.indexLabelTextBlock.y + l.indexLabelTextBlock.height / 2 + b > m && (b = l.indexLabelTextBlock.y + l.indexLabelTextBlock.height / 2 + b - m);
                b = l.indexLabelTextBlock.y + b;
                h = 0;
                h = "right" === l.hemisphere ? v.x + Math.sqrt(Math.pow(indexLabelRadius, 2) - Math.pow(b - v.y, 2)) : v.x - Math.sqrt(Math.pow(indexLabelRadius, 2) - Math.pow(b - v.y, 2));
                p = v.x + A * Math.cos(l.midAngle);
                n = v.y + A * Math.sin(l.midAngle);
                n = Math.sqrt(Math.pow(h - p, 2) + Math.pow(b - n, 2));
                p = Math.acos(A / indexLabelRadius);
                n = Math.acos((indexLabelRadius * indexLabelRadius + A * A - n * n) / (2 *
                    A * indexLabelRadius));
                ...
                g && (c = l.indexLabelTextBlock.y + g, b = 0, b = "right" === l.hemisphere ? v.x + Math.sqrt(Math.pow(indexLabelRadius,
                    ...
                    q.length], "right" === l.hemisphere && "left" === h.hemisphere && b < h.indexLabelTextBlock.x ? b = h.indexLabelTextBlock.x + 15 : "left" === l.hemisphere && ("right" === a.hemisphere && b > a.indexLabelTextBlock.x) && (b = a.indexLabelTextBlock.x - 15)), l.indexLabelTextBlock.y = c, l.indexLabelTextBlock.x = b, l.indexLabelAngle = Math.atan2(l.indexLabelTextBlock.y - v.y, l.indexLabelTextBlock.x - v.x))
            }
            return g
        }
        ...
        function g() {
            ...
            a.textBaseline = "middle";
            for (var b = a = 0, c =
                    0, g = !0, b = 0; 10 > b && (1 > b || 0 < c); b++) {
                if (n.radius || !n.radius && "undefined" !== typeof n.innerRadius && null !== n.innerRadius && A - c <= D) g = !1;
                g && (A -= c);
                c = 0;
                if ("inside" !== n.indexLabelPlacement) {
                    indexLabelRadius = A * t;
                    for (a = 0; a < r.length; a++) {
                        var h = q[a];
                        h.indexLabelTextBlock.x = v.x + indexLabelRadius * Math.cos(h.midAngle);
                        h.indexLabelTextBlock.y = v.y + indexLabelRadius * Math.sin(h.midAngle);
                        h.indexLabelAngle = h.midAngle;
                        h.radius = A;
                        h.percentInnerRadius = F
                    }
                    for (var u, x, a = 0; a < r.length; a++) {
                        var h = q[a],
                            y = e(a);
                        if (null !== y) {
                            u = q[a];
                            ...
                            var B = 0,
                                B = d(u, x) - s;
                            if (0 > B) {
                                for (var C = x = 0, E = 0; E < r.length; E++) E !== a && q[E].hemisphere === h.hemisphere && (q[E].indexLabelTextBlock.y < h.indexLabelTextBlock.y ? x++ : C++);
                                x = B / (x + C || 1) * C;
                                var C = -1 * (B - x),
                                    G = E = 0;
                                "right" === h.hemisphere ? (E = f(a, x), C = -1 * (B - E), G = f(y, C), +G.toFixed(w) < +C.toFixed(w) && +E.toFixed(w) <= +x.toFixed(w) && f(a, -(C - G))) : (E = f(y, x), C = -1 * (B - E), G = f(a, C), +G.toFixed(w) < +C.toFixed(w) && +E.toFixed(w) <= +x.toFixed(w) && f(y, -(C - G)))
                            }
                        }
                    }
                } else
                    for (a = 0; a < r.length; a++) h = q[a], indexLabelRadius = "pie" === n.type ? 0.7 *
                        A : 0.8 * A, y = v.x + indexLabelRadius * Math.cos(h.midAngle), x = v.y + indexLabelRadius * Math.sin(h.midAngle), h.indexLabelTextBlock.x = y, h.indexLabelTextBlock.y = x;
                for (a = 0; a < r.length; a++)
                    if (h = q[a], y = h.indexLabelTextBlock.measureText(), 0 !== y.height && 0 !== y.width) y = y = 0, "right" === h.hemisphere ? (y = l.x2 - (h.indexLabelTextBlock.x + h.indexLabelTextBlock.width + m), y *= -1) : y = l.x1 - (h.indexLabelTextBlock.x - h.indexLabelTextBlock.width - m), 0 < y && (!g && h.indexLabelText && (x = "right" === h.hemisphere ? l.x2 - h.indexLabelTextBlock.x : h.indexLabelTextBlock.x -
                        ...
                        2 + 5), y *= -1) : y = l.y1 - (h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 - 5), 0 < y && (!g && h.indexLabelText && (x = 0 < h.indexLabelAngle && h.indexLabelAngle < Math.PI ? -1 : 1, 0 === f(a, y * x) && f(a, 2 * x)), Math.abs(h.indexLabelTextBlock.x - v.x) < A && (y /= Math.abs(Math.sin(h.indexLabelAngle)), 9 < y && (y *= 0.3), y > c && (c = y)));
                var I = function(a, b, c) {
                    for (var d = [], e = 0; d.push(q[b]), b !== c; b = (b + 1 + r.length) % r.length);
                    d.sort(function(a, b) {
                        return a.y - b.y
                    });
                    for (b = 0; b < d.length; b++)
                ...
                (function() {
                    for (var a = -1, b = -1, c = 0, f = !1, g = 0; g < r.length; g++)
                            ...
                            if (null !== h) {
                                ...
                                if (n = 0 > B) {
                                    ...
                                    var p = u.indexLabelTextBlock.y - u.indexLabelTextBlock.height / 2,
                                        ...
                                        w = l.indexLabelTextBlock.y +
                                        l.indexLabelTextBlock.height / 2;
                                    n = u.indexLabelTextBlock.x + u.indexLabelTextBlock.width < l.indexLabelTextBlock.x - m || n > v + m || p > w + m || s < t - m ? !1 : !0
                                }
                                n ? (0 > a && (a = g), h !== a && (b = h, c += -B), 0 === g % Math.max(r.length / 10, 3) && (f = !0)) : f = !0;
                                f && (0 < c && 0 <= a && 0 <= b) && (I(c, a, b), b = a = -1, c = 0)
                            }
                        }
                    0 < c && I(c, a, b)
                })()
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var n = this.data[a.dataSeriesIndexes[0]],
                ...
                x = 0;
            a = !1;
            for (var y = 0; y < r.length; y++) x += Math.abs(r[y].y), !a && ("undefined" !==
                typeof r[y].indexLabel && null !== r[y].indexLabel && 0 < r[y].indexLabel.toString().length) && (a = !0), !a && ("undefined" !== typeof r[y].label && null !== r[y].label && 0 < r[y].label.toString().length) && (a = !0);
            if (0 !== x) {
                a = a || "undefined" !== typeof n.indexLabel && null !== n.indexLabel && 0 < n.indexLabel.toString().length;
                var A = "inside" !== n.indexLabelPlacement && a ? 0.75 * Math.min(l.width, l.height) / 2 : 0.92 * Math.min(l.width, l.height) / 2;
                n.radius && (A = Ba(n.radius, A));
                var D = "undefined" !== typeof n.innerRadius && null !== n.innerRadius ? Ba(n.innerRadius,
                        A) : 0.7 * A,
                    F = Math.min(D / A, (A - 1) / A);
                this.pieDoughnutClickHandler = function(a) {
                    p.isAnimating || !B(a.dataSeries.explodeOnClick) && !a.dataSeries.explodeOnClick || (a = a.dataPoint, a.exploded = a.exploded ? !1 : !0, 1 < this.dataPoints.length && p._animator.animate(0, 500, function(a) {
                        b(a);
                        h()
                    }))
                };
                ...
                this._animator.animate(0, this.animatedRender ? this.animationDuration : 0, function(a) {
                    ...
                    for (b = 0; b < r.length; b++) {
                        var c = 0 === b ? q[b].startAngle : d,
                            ...
                            e = !1;
                        d > a && (d = a, e = !0);
                        var f = r[b].color ? r[b].color : n._colorSet[b % n._colorSet.length];
                        d > c && sa(p.plotArea.ctx, q[b].center, q[b].radius, f, n.type, c, d, n.fillOpacity, q[b].percentInnerRadius);
                        if (e) break
                    }
                    h()
                }, function() {
    ...
    $.prototype.registerSpace = function(a, c) {
        "top" ===
        a ? this._topOccupied += c.height : "bottom" === a ? this._bottomOccupied += c.height : "left" === a ? this._leftOccupied += c.width : "right" === a && (this._rightOccupied += c.width)
    };
    $.prototype.unRegisterSpace = function(a, c) {
    ...
    M.prototype.render = function(a) {
        ...
        for (b = 0; b < this._wrappedText.lines.length; b++) f = this._wrappedText.lines[b], "right" === this.horizontalAlign ? d = this.width - f.width - this.padding : "left" ===
            this.horizontalAlign ? d = this.padding : "center" === this.horizontalAlign && (d = (this.width - 2 * this.padding) / 2 - f.width / 2 + this.padding), this.ctx.fillText(f.text, d, e), e += f.height;
        this.ctx.font = c;
        a && this.ctx.restore()
    };
    ...
    ca.prototype.render = function() {
        if (this.text) {
            var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart,
                ...
                e = 0,
                f = 0,
                g = this.chart._menuButton && this.chart.exportEnabled && "top" === this.verticalAlign ?
                22 : 0,
                h, p;
            ...
            this.wrap || (f = Math.min(f, Math.max(1.5 *
                this.fontSize, this.fontSize + 2.5 * this.padding)));
    ...
    ka.prototype.render = function() {
        var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart,
            ...
            f = 0,
            g = 0,
            h = this.chart._options.legend && !B(this.chart._options.legend.markerMargin) ? this.chart._options.legend.markerMargin : 0.3 * this.fontSize,
            p = [],
            n = [];
        ...
        for (var r = 0; r < this.dataSeries.length; r++) {
            ...
            if ("pie" !== m.type && "doughnut" !== m.type && "funnel" !== m.type) {
                var l = m.legendMarkerType ?
                    m.legendMarkerType : "line" !== m.type && "stepLine" !== m.type && "spline" !== m.type && "scatter" !== m.type && "bubble" !== m.type || !m.markerType ? U.getDefaultLegendMarker(m.type) : m.markerType,
                    ...
                    s = m.legendMarkerColor ? m.legendMarkerColor : m.markerColor ? m.markerColor : m._colorSet[0],
                    t = m.markerSize || "line" !== m.type && "stepLine" !== m.type && "spline" !== m.type ?
                    0.75 * this.lineHeight : 0,
                    u = m.legendMarkerBorderColor ? m.legendMarkerBorderColor : m.markerBorderColor,
                    v = m.legendMarkerBorderThickness ? m.legendMarkerBorderThickness : m.markerBorderThickness ? Math.max(1, Math.round(0.2 * t)) : 0,
                    q = this.chart.replaceKeywordsWithValue(q, m.dataPoints[0], m, r),
                    l = {
                        markerType: l,
                        markerColor: s,
                        text: q,
                ...
                for (var z = 0; z <
                    m.dataPoints.length; z++) {
                    var x = m.dataPoints[z],
                        l = x.legendMarkerType ? x.legendMarkerType : m.legendMarkerType ? m.legendMarkerType : U.getDefaultLegendMarker(m.type),
                        q = x.legendText ? x.legendText : m.legendText ? m.legendText : this.itemTextFormatter ? this.itemTextFormatter({
                            chart: this.chart._publicChartReference,
                            legend: this._options,
                            dataSeries: m,
                            dataPoint: x
                        }) : x.name ? x.name : "DataPoint: " + (z + 1),
                        s = x.legendMarkerColor ? x.legendMarkerColor : m.legendMarkerColor ? m.legendMarkerColor : x.color ? x.color : m.color ? m.color : m._colorSet[z %
                            m._colorSet.length],
                        t = 0.75 * this.lineHeight,
                        u = x.legendMarkerBorderColor ? x.legendMarkerBorderColor : m.legendMarkerBorderColor ? m.legendMarkerBorderColor : x.markerBorderColor ? x.markerBorderColor : m.markerBorderColor,
                        v = x.legendMarkerBorderThickness ? x.legendMarkerBorderThickness : m.legendMarkerBorderThickness ? m.legendMarkerBorderThickness : x.markerBorderThickness || m.markerBorderThickness ? Math.max(1, Math.round(0.2 * t)) : 0,
                        q = this.chart.replaceKeywordsWithValue(q, x, m, z),
                        l = {
                            markerType: l,
                            markerColor: s,
                            text: q,
                    ...
                    (x.showInLegend || m.showInLegend && !1 !== x.showInLegend) && p.push(l)
                }
        ...
        if (0 < p.length) {
            ...
            for (r = 0; r < p.length; r++) {
                l = p[r];
                if ("line" === l.chartType ||
                    "spline" === l.chartType || "stepLine" === l.chartType) q -= 2 * 0.1 * this.lineHeight;
                if (!(0 >= g || "undefined" === typeof g || 0 >= q || "undefined" === typeof q)) {
                    if ("horizontal" === this.orientation) {
                        ...
                        null !== this.itemWidth &&
                            (l.textBlock.width = this.itemWidth - (t + h + ("line" === l.chartType || "spline" === l.chartType || "stepLine" === l.chartType ? 2 * 0.1 * this.lineHeight : 0)));
                        if (!m || m.width + Math.round(l.textBlock.width + t + h + (0 === m.width ? 0 : this.horizontalSpacing) + ("line" === l.chartType || "spline" === l.chartType || "stepLine" === l.chartType ? 2 * 0.1 * this.lineHeight : 0)) > f) m = {
                            items: [],
                            width: 0
                        }, n.push(m), this.height += z, z = 0;
                        z = Math.max(z, l.textBlock.height)
                        ...
                        fontStyle: this.fontStyle,
                        textBaseline: "middle"
                    }), l.textBlock.measureText(), null !== this.itemWidth && (l.textBlock.width = this.itemWidth - (t + h + ("line" === l.chartType || "spline" === l.chartType || "stepLine" === l.chartType ? 2 * 0.1 * this.lineHeight : 0))), this.height < g - this.lineHeight ? (m = {
                        items: [],
                        width: 0
                    }, n.push(m)) : (m = n[x], x = (x + 1) % n.length), this.height += l.textBlock.height;
            ...
            this.height = !1 === this.itemWrap ? n.length * this.lineHeight : this.height + z;
            this.height = Math.min(g, this.height);
            this.width = Math.min(f, this.width)
        }
        "top" === this.verticalAlign ? (e = "left" === this.horizontalAlign ? c.x1 : "right" === this.horizontalAlign ?
        ...
        this.items = p;
        for (r = 0; r < this.items.length; r++) l = p[r], l.id = ++this.chart._eventManager.lastObjectId, this.chart._eventManager.objectMap[l.id] = {
            id: l.id,
        ...
        for (r = c = 0; r < n.length; r++) {
            m = n[r];
            for (x = z = 0; x < m.items.length; x++) {
                l = m.items[x];
                s = l.textBlock.x + e + (0 === x ? 0.2 * t : this.horizontalSpacing);
                u = d + c;
                q = s;
                ...
                this.ctx.clip();
                if ("line" === l.chartType || "stepLine" === l.chartType || "spline" === l.chartType) this.ctx.strokeStyle =
                    l.lineColor, this.ctx.lineWidth = Math.ceil(this.lineHeight / 8), this.ctx.beginPath(), this.ctx.moveTo(s - 0.1 * this.lineHeight, u + this.lineHeight / 2), this.ctx.lineTo(s + 0.85 * this.lineHeight, u + this.lineHeight / 2), this.ctx.stroke(), q -= 0.1 * this.lineHeight;
                N.drawMarker(s + t / 2, u + this.lineHeight / 2, this.ctx, l.markerType, l.markerSize, l.markerColor, l.markerBorderColor, l.markerBorderThickness);
                l.textBlock.x = s + h + t;
                ...
                this.ctx.restore();
                z = 0 < x ? Math.max(z, l.textBlock.height) : l.textBlock.height;
                this.chart.data[l.dataSeriesIndex].visible || (this.ctx.globalAlpha = 1);
                s = F(l.id);
                this.ghostCtx.fillStyle = s;
                ...
                l.y1 = this.chart._eventManager.objectMap[l.id].y1 = l.textBlock.y - this.lineHeight /
                    2;
    ...
    U.prototype.getDataPointAtX = function(a, c) {
        ...
        var b = {
            ...
            n = 0,
            r = 0;
        "none" !== this.chart.plotInfo.axisPlacement && (r = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x, r = 0 < r ? Math.min(Math.max((this.dataPoints.length -
            1) / r * (a - this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0);
        for (;;) {
            f = 0 < g ? r + e : r - e;
            if (0 <= f && f < this.dataPoints.length) {
                ...
                d = Math.abs(d.x - a);
                d <= h ? h = d : 0 < g ? p++ : n++;
                if (1E3 < p && 1E3 < n) break
            } else if (0 > r - e && r + e >= this.dataPoints.length) break; - 1 === g ? (e++, g = 1) : g = -1
        }
        return c || b.dataPoint.x !== a ? c && null !== b.dataPoint ? b : null : b
    };
    U.prototype.getDataPointAtXY = function(a, c, b) {
        if (!this.dataPoints || 0 === this.dataPoints.length ||
            a < this.chart.plotArea.x1 || a > this.chart.plotArea.x2 || c < this.chart.plotArea.y1 || c > this.chart.plotArea.y2) return null;
        b = b || !1;
        var d = [],
            e = 0,
            f = 0,
            ...
            if (0 <= f && f < this.dataPoints.length) {
                ...
                if (l) {
                    switch (this.type) {
                        ...
                        case "scatter":
                            var t =
                                P("markerSize", q, this) || 4,
                                u = b ? 20 : t,
                                s = Math.sqrt(Math.pow(l.x1 - a, 2) + Math.pow(l.y1 - c, 2));
                            s <= u && d.push({
                                dataPoint: q,
                                dataPointIndex: f,
                                dataSeries: this,
                        ...
                        case "rangeSplineArea":
                            t = P("markerSize", q, this) || 4;
                            u = b ? 20 : t;
                            s = Math.min(Math.sqrt(Math.pow(l.x1 - a, 2) + Math.pow(l.y1 - c, 2)), Math.sqrt(Math.pow(l.x1 - a, 2) + Math.pow(l.y2 - c, 2)));
                            s <= u && d.push({
                                dataPoint: q,
                                dataPointIndex: f,
                                dataSeries: this,
                        ...
                        case "doughnut":
                            ...
                            s = Math.sqrt(Math.pow(t.x - a, 2) + Math.pow(t.y - c, 2));
                            s < l.radius && s > u && (s = Math.atan2(c - t.y, a - t.x), 0 > s && (s += 2 * Math.PI), s = Number(((180 * (s / Math.PI) % 360 + 360) % 360).toFixed(12)), t = Number(((180 * (l.startAngle / Math.PI) % 360 +
                                360) % 360).toFixed(12)), u = Number(((180 * (l.endAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), 0 === u && 1 < l.endAngle && (u = 360), t >= u && 0 !== q.y && (u += 360, s < t && (s += 360)), s > t && s < u && (d.push({
                                dataPoint: q,
                                dataPointIndex: f,
                                dataSeries: this,
                                distance: 0
    ...
    U.prototype.getMarkerProperties = function(a, c, b, d) {
    ...
    E.prototype.createLabels = function() {
        var a, c, b = 0,
            ...
            h = 0,
            p = 0;
        if ("bottom" === this._position || "top" === this._position) p = this.lineCoordinates.width / Math.abs(this.viewportMaximum - this.viewportMinimum) * C[this.intervalType + "Duration"] * this.interval, e = "undefined" === typeof this._options.labelMaxWidth ?
        ...
        else if ("left" === this._position || "right" === this._position) p = this.lineCoordinates.height / Math.abs(this.viewportMaximum - this.viewportMinimum) * C[this.intervalType + "Duration"] * this.interval, this.chart.panEnabled || (e = "undefined" === typeof this._options.labelMaxWidth ? 0.3 * this.chart.width >> 0 : this._options.labelMaxWidth),
        ...
        if ("axisX" === this.type && "dateTime" === this.chart.plotInfo.axisXValueType)
            for (this.intervalStartPosition = this.getLabelStartPoint(new Date(this.viewportMinimum), this.intervalType, this.interval), d = ta(new Date(this.viewportMaximum), this.interval, this.intervalType), b = this.intervalStartPosition; b < d; ta(b, this.interval, this.intervalType)) a = b.getTime(), a = this.labelFormatter ? this.labelFormatter({
                chart: this.chart._publicChartReference,
                axis: this._options,
                value: b,
            ...
            if (this.labels && this.labels.length) {
                ...
                for (var n = Math.ceil(this.intervalStartPosition), f = !1, b = n; b < this.viewportMaximum; b += a)
                    if (this.labels[b]) f = !0;
                    else {
                        f = !1;
                        break
                    }
                f && (this.interval = a, this.intervalStartPosition = n)
            }
            for (b = this.intervalStartPosition; b <= d; b = parseFloat((b + this.interval).toFixed(14))) a = this.labelFormatter ? this.labelFormatter({
                ...
                label: this.labels[b] ?
                    this.labels[b] : null
            }) : "axisX" === this.type && this.labels[b] ? this.labels[b] : Y(b, this.valueFormatString, this.chart._cultureInfo), a = new M(this.ctx, {
                x: 0,
                y: 0,
                maxWidth: e,
                maxHeight: g,
        ...
        if (this.labelAutoFit || this._options.labelAutoFit)
            if ("bottom" === this._position || "top" === this._position)
                if (h = 0, e = 0.9 * p >> 0, B(this.labelAngle) || (this.labelAngle = (this.labelAngle % 360 + 360) % 360, 90 < this.labelAngle && 270 >= this.labelAngle ? this.labelAngle -= 180 : 270 < this.labelAngle && 360 >= this.labelAngle && (this.labelAngle -= 360)), !this.chart.panEnabled && 1 <= this._labels.length) {
                    ...
                    for (b = 0; b < this._labels.length; b++)(a = this._labels[b].textBlock, n = a.measureText(), b < this._labels.length - 1 && (h = b + 1, c = this._labels[h].textBlock, c = c.measureText()), d.push(a.height), this.sessionVariables.labelMaxHeight = Math.max.apply(Math, d), f = e * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)) + (g - a.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), h = e * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)) + (g - a.fontSize /
                        ...
                        0 : this._options.labelMaxWidth : f, this.sessionVariables.labelWrap = this.labelWrap), this.sessionVariables.labelMaxHeight = g);
            ...
            if (e = B(this._options.labelMaxWidth) ? 0.3 * this.chart.width >> 0 : this._options.labelMaxWidth, B(this.labelAngle) || (this.labelAngle = (this.labelAngle % 360 + 360) % 360, 90 < this.labelAngle && 270 >= this.labelAngle ? this.labelAngle -= 180 : 270 < this.labelAngle && 360 >= this.labelAngle && (this.labelAngle -= 360)), !this.chart.panEnabled && 1 <= this._labels.length) {
                ...
                this.sessionVariables.labelAngle = B(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle;
                this.sessionVariables.labelWrap = !0;
                for (b = 0; b < this._labels.length; b++)(a = this._labels[b].textBlock, n = a.measureText(), b < this._labels.length - 1 && (h = b + 1, c = this._labels[h].textBlock, c = c.measureText()), f.push(a.height), this.sessionVariables.labelMaxHeight = Math.max.apply(Math, f), h = e * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)) +
                ...
                for (k = 0; k < this._labels.length; k++) a = this._labels[k].textBlock, a.maxWidth = this.labelMaxWidth = this.sessionVariables.labelMaxWidth,
                    a.fontSize = this.labelFontSize = this.sessionVariables.labelFontSize, a.angle = this.labelAngle = this.sessionVariables.labelAngle, a.wrap = this.labelWrap = this.sessionVariables.labelWrap, a.maxHeight = this.sessionVariables.labelMaxHeight, a.measureText()
            } else
                for (b = 0; b < this._labels.length; b++) a = this._labels[b].textBlock, a.maxWidth = this.labelMaxWidth = B(this._options.labelMaxWidth) ? this.sessionVariables.labelMaxWidth : this._options.labelMaxWidth, a.fontSize = this.labelFontSize = B(this._options.labelFontSize) ? this.sessionVariables.labelFontSize :
                    this._options.labelFontSize, a.angle = this.labelAngle = B(this._options.labelAngle) ? this.sessionVariables.labelAngle : this.labelAngle, a.wrap = this.labelWrap = B(this._options.labelWrap) ? this.sessionVariables.labelWrap : this._options.labelWrap, a.maxHeight = this.sessionVariables.labelMaxHeight, a.measureText();
        for (b = 0; b < this.stripLines.length; b++) e = this.stripLines[b], g = "bottom" === this._position || "top" === this._position ? 0.9 * this.chart.width >> 0 : 0.9 * this.chart.height >> 0, a = new M(this.ctx, {
                x: 0,
                y: 0,
                backgroundColor: "outside" ===
                    e.labelPlacement ? e._options.labelBackgroundColor ? e._options.labelBackgroundColor : "#EEEEEE" : e.startValue ? "#EEEEEE" : e.labelBackgroundColor,
                maxWidth: e._options.labelMaxWidth ? e._options.labelMaxWidth : g,
                maxHeight: "undefined" === typeof e._options.labelWrap || e.labelWrap ? g : 1.5 * this.labelFontSize,
                angle: this.labelAngle,
                ...
                horizontalAlign: "left",
                fontSize: "outside" === e.labelPlacement ? e._options.labelFontSize ?
                    e._options.labelFontSize : this.labelFontSize : e.labelFontSize,
                fontFamily: "outside" === e.labelPlacement ? e._options.labelFontFamily ? e._options.labelFontFamily : this.labelFontFamily : e.labelFontFamily,
                fontWeight: "outside" === e.labelPlacement ? e._options.fontWeight ? e._options.fontWeight : this.fontWeight : e.fontWeight,
                fontColor: e._options.labelFontColor || e.labelFontColor,
                fontStyle: "outside" === e.labelPlacement ? e._options.fontStyle ? e._options.fontStyle : this.fontWeight : e.fontStyle,
                textBaseline: "middle",
                borderThickness: 0
            }),
    ...
    E.prototype.createLabelsAndCalculateWidth = function() {
        ...
        if ("left" === this._position || "right" === this._position) {
            ...
            for (i = 0; i < this._labels.length; i++) {
                var c = this._labels[i].textBlock,
                    b = c.measureText(),
                    d = 0,
                    d = 0 === this.labelAngle ? b.width : b.width * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)) + (b.height - c.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle));
                a < d && (a = d);
                this._labels[i].effectiveWidth = d
            }
            for (i = 0; i < this._stripLineLabels.length; i++) "outside" === this._stripLineLabels[i].stripLine.labelPlacement && (c = this._stripLineLabels[i].textBlock, b = c.measureText(), d = 0 === this.labelAngle ? b.width : b.width * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)) + (b.height - c.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), a < d && (a = d), this._stripLineLabels[i].effectiveWidth = d)
        }
        return (this.title ? this._titleTextBlock.measureText().height + 2 : 0) + a + this.tickLength +
            5
    };
    E.prototype.createLabelsAndCalculateHeight = function() {
        ...
        if ("bottom" === this._position || "top" === this._position) {
            ...
            for (b = 0; b < this._stripLineLabels.length; b++) "outside" ===
                this._stripLineLabels[b].stripLine.labelPlacement && (c = this._stripLineLabels[b].textBlock, d = c.measureText(), e = 0 === this.labelAngle ? d.height : d.width * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)) + (d.height - c.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)), a < e && (a = e), this._labels[b].effectiveHeight = e)
        }
        return (this.title ? this._titleTextBlock.measureText().height + 2 : 0) + a + this.tickLength + 5
    };
    E.setLayoutAndRender = function(a, c, b, d, e) {
        var f, g, h, p = a.chart,
            n = p.ctx;
        ...
        if ("normal" === d) {
            ...
            c &&
                c.title && (c._titleTextBlock.maxWidth = c.titleMaxWidth || e.height, c._titleTextBlock.maxHeight = c.titleWrap ? 0.8 * e.width : 1.5 * c.titleFontSize, c._titleTextBlock.angle = -90);
            ...
            for (; 4 > l++;) a.lineCoordinates = {}, t = Math.ceil(c ? c.createLabelsAndCalculateWidth() : 0), f = Math.round(e.x1 + t + r), u = Math.ceil(b ? b.createLabelsAndCalculateWidth() : 0), g = Math.round(e.x2 -
                ...
                d, a.boundingRect = {
                    ...
                    width: g - f,
                    height: h - d
                }, c && (f = Math.round(e.x1 + c.margin), d = Math.round(10 > e.y1 ? 10 : e.y1), g = Math.round(e.x1 + t + c.margin), h = Math.round(e.y2 - v - a.margin), c.lineCoordinates = {
                    x1: g,
                    y1: d,
                    x2: g,
                    y2: h,
                    ...
                    width: g - f,
                    height: h - d
                }, c.title && (c._titleTextBlock.maxWidth = 0 < c.titleMaxWidth && c.titleMaxWidth < c.lineCoordinates.height ? c.titleMaxWidth : c.lineCoordinates.height)), b && (f = Math.round(a.lineCoordinates.x2), d = Math.round(10 > e.y1 ?
                    10 : e.y1), g = Math.round(f + u), h = Math.round(e.y2 - v - a.margin), b.lineCoordinates = {
                    x1: f,
                    y1: d,
                    x2: f,
                    y2: h,
            ...
            for (; 4 > l++;) m = Math.ceil(a.createLabelsAndCalculateWidth()), c && (c.lineCoordinates = {}, f = Math.round(e.x1 + m + a.margin), g = Math.round(e.x2 > c.chart.width - 10 ? c.chart.width - 10 : e.x2), c.labelAutoFit && !B(t) && (f = 0 > c.labelAngle ? Math.max(f, t) : 0 === c.labelAngle ? Math.max(f, t / 2) : f, g = 0 < c.labelAngle ? g - u : 0 === c.labelAngle ? g - u / 2 : g), c.lineCoordinates.x1 = f, c.lineCoordinates.x2 = g, c.lineCoordinates.width = Math.abs(g - f), c.title && (c._titleTextBlock.maxWidth = 0 < c.titleMaxWidth && c.titleMaxWidth < c.lineCoordinates.width ?
                ...
                e.y2 - r), c.lineCoordinates.y1 = d, c.lineCoordinates.y2 = d, c.boundingRect = {
                x1: f,
                y1: d,
                x2: g,
                y2: h,
                width: g - f,
                height: x
            }, c.title && (c._titleTextBlock.maxWidth = 0 < c.titleMaxWidth && c.titleMaxWidth < c.lineCoordinates.width ? c.titleMaxWidth : c.lineCoordinates.width)), b && (d = Math.round(e.y1 + b.margin), h = e.y1 + b.margin + y, b.lineCoordinates.y1 = h, b.lineCoordinates.y2 = h, b.boundingRect = {
                x1: f,
                y1: d,
                x2: g,
                y2: h,
                width: g - f,
                height: y
            }, b.title && (b._titleTextBlock.maxWidth = 0 < b.titleMaxWidth && b.titleMaxWidth < b.lineCoordinates.width ? b.titleMaxWidth :
                b.lineCoordinates.width)), f = Math.round(e.x1 + a.margin), d = Math.round(b ? b.lineCoordinates.y2 : 10 > e.y1 ? 10 : e.y1), g = Math.round(e.x1 + m + a.margin), h = Math.round(c ? c.lineCoordinates.y1 : e.y2 - r > a.chart.height - 10 ? a.chart.height - 10 : e.y2 - r), c && c.labelAutoFit && (g = 0 > c.labelAngle ? Math.max(g, t) : 0 === c.labelAngle ? Math.max(g, t / 2) : g, f = 0 > c.labelAngle || 0 === c.labelAngle ? g - m : f), b && b.labelAutoFit && (g = b.lineCoordinates.x1, f = g - m), a.lineCoordinates = {
                x1: g,
                y1: d,
                x2: g,
                y2: h,
                ...
                width: g -
                    f,
                height: h - d
            }, a.title && (a._titleTextBlock.maxWidth = 0 < a.titleMaxWidth && a.titleMaxWidth < a.lineCoordinates.height ? a.titleMaxWidth : a.lineCoordinates.height), a.calculateValueToPixelConversionParameters(), c && c.calculateValueToPixelConversionParameters(), b && b.calculateValueToPixelConversionParameters();
            c && c.renderLabelsTicksAndTitle();
            b && b.renderLabelsTicksAndTitle();
            a.renderLabelsTicksAndTitle()
        }
        ...
        e = a.chart.plotArea;
        n.save();
        n.rect(e.x1, e.y1, Math.abs(e.x2 - e.x1), Math.abs(e.y2 - e.y1));
        n.clip();
    ...
    E.prototype.renderLabelsTicksAndTitle =
        function() {
            var a = !1,
                c = 0,
                b = 1,
            ...
            if ("undefined" === typeof this._options.interval) {
                if ("bottom" === this._position || "top" === this._position) {
                    for (e = 0; e < this._labels.length; e++) f = this._labels[e], f.position < this.viewportMinimum || f.stripLine || (f = f.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) + f.textBlock.height * Math.sin(Math.PI / 180 * this.labelAngle), c += f);
                    c > this.lineCoordinates.width * b && this.labelAutoFit && (a = !0)
                }
                if ("left" === this._position || "right" ===
                    this._position) {
                    for (e = 0; e < this._labels.length; e++) f = this._labels[e], f.position < this.viewportMinimum || f.stripLine || (f = f.textBlock.height * Math.cos(Math.PI / 180 * this.labelAngle) + f.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle), c += f);
                    c > this.lineCoordinates.height * b && this.labelAutoFit && (a = !0)
                }
            }
            if ("bottom" === this._position) {
                for (var e = 0, f, e = 0; e < this._labels.length; e++) f = this._labels[e], f.position < this.viewportMinimum || f.position > this.viewportMaximum || (c = this.getPixelCoordinatesOnAxis(f.position), this.tickThickness &&
                ...
                for (e = 0; e < this._labels.length; e++) f = this._labels[e], f.position < this.viewportMinimum || f.position > this.viewportMaximum ||
                    (c = this.getPixelCoordinatesOnAxis(f.position), this.tickThickness && (this.ctx.lineWidth = this.tickThickness, this.ctx.strokeStyle = this.tickColor, b = 1 === this.ctx.lineWidth % 2 ? (c.x << 0) + 0.5 : c.x << 0, this.ctx.beginPath(), this.ctx.moveTo(b, c.y << 0), this.ctx.lineTo(b, c.y - this.tickLength << 0), this.ctx.stroke()), a && 0 !== d++ % 2 && this.labelAutoFit || (0 === f.textBlock.angle ? (c.x -= f.textBlock.width / 2, c.y -= this.tickLength + f.textBlock.height) : (c.x += (f.textBlock.height - this.tickLength - this.labelFontSize / 2) * Math.sin(Math.PI / 180 *
                        this.labelAngle) - (0 < this.labelAngle ? f.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) : 0), c.y -= this.tickLength + (f.textBlock.height * Math.cos(Math.PI / 180 * this.labelAngle) + (0 < this.labelAngle ? f.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) : 0))), f.textBlock.x = c.x, f.textBlock.y = c.y, f.textBlock.render(!0)));
                this.title && (this._titleTextBlock.measureText(), this._titleTextBlock.x = this.lineCoordinates.x1 + this.lineCoordinates.width / 2 - this._titleTextBlock.width / 2, this._titleTextBlock.y = this.boundingRect.y1 +
                    1, this._titleTextBlock.render(!0))
                ...
                for (e = 0; e < this._labels.length; e++) f = this._labels[e], f.position < this.viewportMinimum || f.position > this.viewportMaximum || (c = this.getPixelCoordinatesOnAxis(f.position), this.tickThickness && (this.ctx.lineWidth = this.tickThickness, this.ctx.strokeStyle =
                    ...
                    180 * this.labelAngle) + this.tickLength : c.x + this.tickLength + 5), f.textBlock.render(!0)));
    ...
    E.prototype.renderInterlacedColors = function() {
        ...
        if (("bottom" === this._position || "top" === this._position) && this.interlacedColor)
            ...
            for (a.fillStyle = this.interlacedColor, e = 0; e < this._labels.length; e++) this._labels[e].stripLine ||
    ...
    E.prototype.renderStripLinesOfThicknessType = function(a) {
        if (this.stripLines && 0 < this.stripLines.length && a) {
            ...
            for (d = 0; d < this._stripLineLabels.length; d++)
                if (b = this._stripLineLabels[d], !(b.position < this.viewportMinimum || b.position > this.viewportMaximum))
                    if (a = this.getPixelCoordinatesOnAxis(b.position),
                        ...
                        if ("bottom" === this._position) {
                            ...
                            this.ctx.stroke();
                            0 === this.labelAngle ? (a.x -= b.textBlock.width / 2, a.y += this.tickLength + b.textBlock.fontSize / 2) : (a.x -= 0 > this.labelAngle ? b.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) : 0, a.y += this.tickLength +
                                Math.abs(0 > this.labelAngle ? b.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) + 5 : 5))
                        } else "top" === this._position ? (f = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0, this.ctx.beginPath(), this.ctx.moveTo(f, a.y << 0), this.ctx.lineTo(f, a.y - this.tickLength << 0), this.ctx.stroke(), 0 === this.labelAngle ? (a.x -= b.textBlock.width / 2, a.y -= this.tickLength + b.textBlock.height) : (a.x += (b.textBlock.height - this.tickLength - this.labelFontSize / 2) * Math.sin(Math.PI / 180 * this.labelAngle) - (0 < this.labelAngle ? b.textBlock.width * Math.cos(Math.PI /
                            ...
                            5 : (a.y = 0 > this.labelAngle ? a.y : a.y - (b.textBlock.height - b.textBlock.fontSize / 2 - 5) * Math.cos(Math.PI / 180 * this.labelAngle), a.x = 0 < this.labelAngle ? a.x + (b.textBlock.height - b.textBlock.fontSize / 2 - 5) * Math.sin(Math.PI / 180 * this.labelAngle) + this.tickLength : a.x + this.tickLength + 5));
                        b.textBlock.x = a.x;
                        b.textBlock.y = a.y;
    ...
    E.prototype.renderGrid = function() {
        if (this.gridThickness && 0 < this.gridThickness) {
            ...
            a.setLineDash && a.setLineDash(G(this.gridDashType,
                this.gridThickness));
            if ("bottom" === this._position || "top" === this._position)
                for (d = 0; d < this._labels.length && !this._labels[d].stripLine; d++) this._labels[d].position < this.viewportMinimum || this._labels[d].position > this.viewportMaximum || (a.beginPath(), c = this.getPixelCoordinatesOnAxis(this._labels[d].position), c = 1 === a.lineWidth % 2 ? (c.x << 0) + 0.5 : c.x << 0, a.moveTo(c, b.y1 << 0), a.lineTo(c, b.y2 << 0), a.stroke());
            else if ("left" === this._position || "right" === this._position)
    ...
    E.prototype.getPixelCoordinatesOnAxis = function(a) {
        ...
        if ("left" === this._position || "right" ===
            this._position) b = -this.conversionParameters.pixelPerUnit, c.y = this.conversionParameters.reference - b * (a - this.viewportMinimum), c.x = this.lineCoordinates.x2;
        return c
    };
    ...
    E.prototype.setViewPortRange = function(a, c) {
    ...
    E.prototype.calculateValueToPixelConversionParameters = function(a) {
        ...
        if ("bottom" === this._position || "top" === this._position) a.pixelPerUnit = (this.reversed ? -1 : 1) * c / Math.abs(this.viewportMaximum - this.viewportMinimum), a.reference = this.reversed ? this.lineCoordinates.x2 :
    ...
    E.prototype.calculateAxisParameters = function() {
        var a = this.chart.layoutManager.getFreeSpace(),
            c = !1;
        "bottom" === this._position || "top" === this._position ? (this.maxWidth = a.width, this.maxHeight = a.height) : (this.maxWidth = a.height, this.maxHeight =
            a.width);
        ...
        "axisX" === this.type ? (b = null !== this.viewportMinimum ? this.viewportMinimum : this.dataInfo.viewPortMin, d = null !== this.viewportMaximum ? this.viewportMaximum : this.dataInfo.viewPortMax,
            ...
            0 > d && (d = 0));
        f = (isNaN(this.viewportMaximum) || null === this.viewportMaximum ? d : this.viewportMaximum) - (isNaN(this.viewportMinimum) || null === this.viewportMinimum ? b : this.viewportMinimum);
        if ("axisX" === this.type && "dateTime" === this.chart.plotInfo.axisXValueType) {
            this.intervalType || (f / 1 <= a ? (this.interval = 1, this.intervalType = "millisecond") : f / 2 <= a ? (this.interval = 2, this.intervalType = "millisecond") : f / 5 <= a ? (this.interval = 5, this.intervalType = "millisecond") : f / 10 <= a ? (this.interval = 10, this.intervalType = "millisecond") :
                ...
                f / (2 * C.weekDuration) <= a ? (this.interval = 2, this.intervalType = "week") : f / (3 * C.weekDuration) <= a ? (this.interval = 3, this.intervalType = "week") : f / (1 * C.monthDuration) <= a ? (this.interval = 1, this.intervalType = "month") : f / (2 * C.monthDuration) <= a ? (this.interval = 2, this.intervalType = "month") : f / (3 * C.monthDuration) <= a ? (this.interval = 3, this.intervalType = "month") : f / (6 * C.monthDuration) <= a ? (this.interval = 6, this.intervalType = "month") : (this.interval = f / (1 * C.yearDuration) <= a ? 1 : f / (2 * C.yearDuration) <= a ? 2 : f / (4 * C.yearDuration) <= a ?
                    4 : Math.floor(E.getNiceNumber(f / (a - 1), !0) / C.yearDuration), this.intervalType = "year"));
            if (null === this.viewportMinimum || isNaN(this.viewportMinimum)) this.viewportMinimum = b - e / 2;
            ...
            f = E.getNiceNumber(f, !1);
            this.interval = this._options &&
                0 < this._options.interval ? this._options.interval : E.getNiceNumber(f / (a - 1), !0);
            if (null === this.viewportMinimum || isNaN(this.viewportMinimum)) this.viewportMinimum = "axisX" === this.type ? b - e / 2 : Math.floor(b / this.interval) * this.interval;
            ...
            0 === this.viewportMaximum && 0 === this.viewportMinimum && (0 === this._options.viewportMinimum ? this.viewportMaximum += 10 : 0 === this._options.viewportMaximum &&
                (this.viewportMinimum -= 10), this._options && "undefined" === typeof this._options.interval && (this.interval = E.getNiceNumber((this.viewportMaximum - this.viewportMinimum) / (a - 1), !0)))
        }
        if (null === this.minimum || null === this.maximum)
            if ("axisX" === this.type ? (b = null !== this.minimum ? this.minimum : this.dataInfo.min, d = null !== this.maximum ? this.maximum : this.dataInfo.max, 0 === d - b && (f = "undefined" === typeof this._options.interval ? 0.4 : this._options.interval, d += f, b -= f), e = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 <
                    ...
                    this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < d - b ? 0.5 * Math.abs(d - b) : 1, this.includeZero && (null === this.minimum || isNaN(this.minimum)) && 0 < b && (b = 0), this.includeZero && (null === this.maximum || isNaN(this.maximum)) && 0 > d && (d = 0)), "axisX" === this.type && "dateTime" === this.chart.plotInfo.axisXValueType) {
                if (null === this.minimum || isNaN(this.minimum)) this.minimum = b - e / 2;
                if (null === this.maximum || isNaN(this.maximum)) this.maximum = d + e / 2
            } else this.intervalType = "number", null === this.minimum && (this.minimum = "axisX" === this.type ? b -
        ...
        this.intervalStartPosition = "axisX" === this.type && "dateTime" === this.chart.plotInfo.axisXValueType ? this.getLabelStartPoint(new Date(this.viewportMinimum), this.intervalType, this.interval) : Math.floor((this.viewportMinimum + 0.2 * this.interval) / this.interval) *
            this.interval;
    ...
    E.prototype.getLabelStartPoint = function() {
        var a =
            C[this.intervalType + "Duration"] * this.interval,
    ...
    S.prototype._updateToolTip = function(a, c) {
        if (!this.chart.disableToolTip) {
            ...
            if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                f = "xySwapped" === this.chart.plotInfo.axisPlacement ? (this.chart.axisX.viewportMaximum - this.chart.axisX.viewportMinimum) / this.chart.axisX.lineCoordinates.height * (this.chart.axisX.lineCoordinates.y2 - c) + this.chart.axisX.viewportMinimum : (this.chart.axisX.viewportMaximum - this.chart.axisX.viewportMinimum) /
                ...
                if (g = this.chart.getDataPointAtXY(a,
                        c, !0)) this.currentDataPointIndex = g.dataPointIndex, this.currentSeriesIndex = g.dataSeries.index;
                else if (v)
                    if (g = ya(a, c, this.chart._eventManager.ghostCtx), 0 < g && "undefined" !== typeof this.chart._eventManager.objectMap[g]) {
            ...
            if ((e = this.chart._eventManager.objectMap[e.dataSeries.dataPointIds[e.index]]) && e.objectType && "dataPoint" === e.objectType) {
                ...
                !1 === f.highlightEnabled || !0 !== d.highlightEnabled && !0 !== f.highlightEnabled || ("line" === d.type || "stepLine" === d.type || "spline" === d.type || "scatter" === d.type ||
                    "area" === d.type || "stepArea" === d.type || "splineArea" === d.type || "stackedArea" === d.type || "stackedArea100" === d.type || "rangeArea" === d.type || "rangeSplineArea" === d.type ? (f = d.getMarkerProperties(g, e.x1, e.y1, this.chart.overlaidCanvasCtx), f.size = Math.max(1.5 * f.size << 0, 10), f.borderColor = f.borderColor || "#FFFFFF", f.borderThickness = f.borderThickness || Math.ceil(0.1 * f.size), N.drawMarkers([f]), "undefined" !== typeof e.y2 && (f = d.getMarkerProperties(g, e.x1, e.y2, this.chart.overlaidCanvasCtx), f.size = Math.max(1.5 * f.size <<
                        ...
                        e.y4), "transparent", 2 * e.borderThickness, e.color, !1, !1, !1, !1), c.globalAlpha = 1) : "ohlc" === d.type && (c.globalAlpha = 1, c.strokeStyle = e.color, c.lineWidth = 2 * e.borderThickness, d = 0 === c.lineWidth % 2 ? 0 : 0.5, c.beginPath(), c.moveTo(e.x3 - d, e.y2), c.lineTo(e.x3 - d, e.y3), c.stroke(), c.beginPath(), c.moveTo(e.x3, e.y1), c.lineTo(e.x1, e.y1), c.stroke(), c.beginPath(), c.moveTo(e.x3, e.y4), c.lineTo(e.x2, e.y4), c.stroke(), c.globalAlpha = 1))
            }
        }
        c.restore();
        c.globalAlpha = 1;
    ...
    S.prototype.getToolTipInnerHTML = function(a) {
        ...
        if (g && (this.content && "function" === typeof this.content || this.contentFormatter)) a = {
            ...
            for (var p = "", h = 0; h < a.length; h++)
                if (b = a[h].dataSeries, d = a[h].dataPoint, e = a[h].index,
                    ...
                    if ("line" === b.type || "stepLine" === b.type || "spline" === b.type || "area" === b.type || "stepArea" === b.type || "splineArea" === b.type || "column" === b.type || "bar" === b.type || "scatter" === b.type || "stackedColumn" === b.type || "stackedColumn100" ===
                        b.type || "stackedBar" === b.type || "stackedBar100" === b.type || "stackedArea" === b.type || "stackedArea100" === b.type) f += d.toolTipContent ? d.toolTipContent : b.toolTipContent ? b.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.fontColor ? "" : "'color:{color};'") + "\"'>{name}:</span>&nbsp;&nbsp;{y}";
                    ...
                    else if ("candlestick" === b.type || "ohlc" === b.type) f += d.toolTipContent ?
            ...
            if ("line" === b.type || "stepLine" === b.type || "spline" === b.type || "area" === b.type || "stepArea" === b.type || "splineArea" === b.type || "column" === b.type || "bar" === b.type || "scatter" === b.type || "stackedColumn" === b.type || "stackedColumn100" === b.type || "stackedBar" === b.type || "stackedBar100" === b.type || "stackedArea" === b.type || "stackedArea100" === b.type) f =
                d.toolTipContent ? d.toolTipContent : b.toolTipContent ? b.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.fontColor ? "" : "'color:{color};'") + "\"'>" + (d.label ? "{label}" : "{x}") + ":</span>&nbsp;&nbsp;{y}";
            else if ("bubble" === b.type) f = d.toolTipContent ? d.toolTipContent : b.toolTipContent ? b.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.fontColor ? "" : "'color:{color};'") + "\"'>" + (d.label ? "{label}" : "{x}") + ":</span>&nbsp;&nbsp;{y}, &nbsp;&nbsp;{z}";
            ...
            else if ("rangeColumn" === b.type || "rangeBar" === b.type || "rangeArea" === b.type || "rangeSplineArea" === b.type) f = d.toolTipContent ? d.toolTipContent : b.toolTipContent ?
                b.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.fontColor ? "" : "'color:{color};'") + "\"'>" + (d.label ? "{label}" : "{x}") + " :</span>&nbsp;&nbsp;{y[0]}, &nbsp;{y[1]}";
            else if ("candlestick" === b.type || "ohlc" === b.type) f = d.toolTipContent ? d.toolTipContent : b.toolTipContent ? b.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.fontColor ? "" : "'color:{color};'") + "\"'>" + (d.label ? "{label}" : "{x}") + "</span><br/>Open: &nbsp;&nbsp;{y[0]}<br/>High: &nbsp;&nbsp;&nbsp;{y[1]}<br/>Low: &nbsp;&nbsp;&nbsp;&nbsp;{y[2]}<br/>Close: &nbsp;&nbsp;{y[3]}";
            null === c && (c = "");
    ...
    A.prototype.getPercentAndTotal = function(a, c) {
        ...
        if (0 <= a.type.indexOf("stacked")) d = 0, b = c.x.getTime ? c.x.getTime() : c.x, b in a.plotUnit.yTotals &&
            (d = a.plotUnit.yTotals[b], e = isNaN(c.y) ? 0 : 0 === d ? 0 : 100 * (c.y / d));
        ...
        if ((0 <= b.type.indexOf("stacked") || "pie" === b.type || "doughnut" === b.type) && (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))) {
            ...
            do {
                ...
                if (b.percentFormatString) p = b.percentFormatString;
                    ...
                    var p = "#,##0.",
                        n = Math.max(Math.ceil(Math.log(1 / Math.abs(g)) / Math.LN10), 2);
        ...
        return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function(a) {
            ...
            return "x" === a ? "dateTime" === f.plotInfo.axisXValueType || "dateTime" ===
                b.xValueType || c.x && c.x.getTime ? ra(h, c.xValueFormatString ? c.xValueFormatString : b.xValueFormatString ? b.xValueFormatString : f.axisX && f.axisX.autoValueFormatString ? f.axisX.autoValueFormatString : "DD MMM YY", f._cultureInfo) : Y(h, c.xValueFormatString ? c.xValueFormatString : b.xValueFormatString ? b.xValueFormatString : "#,##0.########", f._cultureInfo) : "y" === a ? Y(h, c.yValueFormatString ? c.yValueFormatString : b.yValueFormatString ? b.yValueFormatString : "#,##0.########", f._cultureInfo) : "z" === a ? Y(h, c.zValueFormatString ? c.zValueFormatString :
                    b.zValueFormatString ? b.zValueFormatString : "#,##0.########", f._cultureInfo) : h
        })
    };
    ...
    ba.prototype.mouseEventHandler = function(a) {
        if ("mousemove" === a.type || "click" === a.type) {
            ...
            for (b = 0; b < this.mouseoveredObjectMaps.length; b++) {
                ...
                f ? this.fireEvent(this.mouseoveredObjectMaps[b], "mouseout",
                    a) : e.push(this.mouseoveredObjectMaps[b])
            }
    ...
    ba.prototype.fireEvent = function(a, c, b) {
        if (a && c) {
    ...
    Q(da, J);
    qa.prototype.animate = function(a, c, b, d, e) {
        var f = this;
        ...
        for (a = []; 0 < this.animations.length;)
            if (c = this.animations.shift(), b = (new Date).getTime(), d = 0, c.startTime <= b && (d = e(Math.min(b - c.startTime, c.duration), 0, 1, c.duration), d = Math.min(d, 1), isNaN(d) || !isFinite(d)) && (d = 1), 1 > d && a.push(c), c.animationCallback(d), 1 <= d && c.onComplete) c.onComplete();
        this.animations = a;
    ...
    var D = {
            yScaleAnimation: function(a, c) {
                if (0 !== a) {
                    var b = c.dest,
                        d = c.source.canvas,
                        e = c.animationBase;
                    b.drawImage(d, 0, 0, d.width, d.height, 0, e - e * a, b.canvas.width / L, a * b.canvas.height / L)
                }
            },
            xScaleAnimation: function(a, c) {
                if (0 !== a) {
                    var b = c.dest,
                        ...
                        e = c.animationBase;
                    b.drawImage(d, 0, 0,
                        d.width, d.height, e - e * a, 0, a * b.canvas.width / L, b.canvas.height / L)
                }
            },
            xClipAnimation: function(a, c) {
                if (0 !== a) {
                    var b = c.dest,
                        d = c.source.canvas;
                    b.save();
                    0 < a && b.drawImage(d, 0, 0, d.width * a, d.height, 0, 0, d.width * a / L, d.height / L);
                    b.restore()
                }
            },
            fadeInAnimation: function(a, c) {
                if (0 !== a) {
                    ...
                    b.save();
                    b.globalAlpha = a;
                    b.drawImage(d, 0, 0, d.width, d.height, 0, 0, b.canvas.width / L, b.canvas.height / L);
                    b.restore()
                }
            },
            easing: {
        ...
        N = {
            drawMarker: function(a, c, b, d, e, f, g, h) {
                if (b) {
                    ...
                    b.lineWidth = h ? h : 0;
                    "circle" === d ? (b.moveTo(a, c), b.beginPath(), b.arc(a, c, e / 2, 0, 2 * Math.PI, !1), f && b.fill(), h && (g ? b.stroke() : (p = b.globalAlpha, b.globalAlpha = 0.15, b.strokeStyle = "black", b.stroke(), b.globalAlpha = p))) :
                        "square" === d ? (b.beginPath(), b.rect(a - e / 2, c - e / 2, e, e), f && b.fill(), h && (g ? b.stroke() : (p = b.globalAlpha, b.globalAlpha = 0.15, b.strokeStyle = "black", b.stroke(), b.globalAlpha = p))) : "triangle" === d ? (b.beginPath(), b.moveTo(a - e / 2, c + e / 2), b.lineTo(a + e / 2, c + e / 2), b.lineTo(a, c - e / 2), b.closePath(), f && b.fill(), h && (g ? b.stroke() : (p = b.globalAlpha, b.globalAlpha = 0.15, b.strokeStyle = "black", b.stroke(), b.globalAlpha = p)), b.beginPath()) : "cross" === d && (b.strokeStyle = f, b.lineWidth = e / 4, b.beginPath(), b.moveTo(a - e / 2, c - e / 2), b.lineTo(a + e /
                            2, c + e / 2), b.stroke(), b.moveTo(a + e / 2, c - e / 2), b.lineTo(a - e / 2, c + e / 2), b.stroke())
                }
            },
        ...
        Ca = {
            ...
            formatNumber: function(a, c, b) {
                b = b || "en";
                if (ea[b]) return Y(a, c || "#,##0.##", new da(b));
                throw "Unknown Culture Name";
            },
            formatDate: function(a, c, b) {
                b = b || "en";
                if (ea[b]) return ra(a, c || "DD MMM YYYY", new da(b));
                throw "Unknown Culture Name";
            }
        };
    Ca.Chart.version = "v1.8.1 Beta 1";
    window.CanvasJS = Ca
})();
/*
