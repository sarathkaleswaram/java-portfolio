							...
							<div>
								...
								<div class="widget-body no-padding">
									<table id="datatable_tabletools"
										...
										<tbody>
											<tr ng-repeat="list in getAPTInboxList">
												<td style="text-align: center;">{{$index+1}}</td>
												<td>{{list.resourceByAssignedFrom}}</td>
					...
					<div class="main-content">
						<form name="theForm" novalidate="novalidate">
							<div class="form-group row">
								<div class="col-lg-6">
									<label>From : </label> <input type="text"
										...
										ng-model="formModel.resourceByAssignedFrom"
										class="form-control" ng-disabled="true">
								</div>
								<div class="col-lg-6">
									<label>To : </label> <input type="text"
										placeholder="Enter Subject"
										ng-model="formModel.resourceByAssignedTo" class="form-control"
										ng-disabled="true">
								</div>
							...
							<div class="form-group">
								<label>Cc : </label> <input type="text"
									ng-model="formModel.stackHolders" class="form-control"
									ng-disabled="true">
							</div>

							<div class="form-group">
								<label>Subject : </label> <input type="text"
									placeholder="Enter Subject" ng-model="formModel.subject"
									class="form-control" ng-disabled="true">
							</div>

							<div class="form-group">
								<label>Description : </label>
								<textarea rows="10" ng-model="angularDescription"
									class="form-control" ng-disabled="true"></textarea>
							</div>
							...
							<div class="form-group row">
								...
								<div class="col-lg-3">
									<label>End Date</label> <input type="text" class="form-control"
										...
										placeholder="Select End Date" ng-disabled="true" />
								</div>
								<div class="col-lg-3">
									<label>Priority</label> <select id="priority"
										ng-disabled="true" ng-model="formModel.priority"
										class="form-control">
								...
								<div class="col-lg-3">
									<label><span class="asterisc">*</span>Status</label> <select
										id="aptStatus" ng-disabled="false" ng-model="aptStatus"
								...
								<div class="form-group">
									<div align="center">
										<button class="btn btn-primary btn-lg" type="submit"
											onClick="window.location.reload()" ng-click="addTask()"
											ng-disabled="theForm.$invalid">Submit</button>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="model-footer">
					<form:form commandName="inboxremarks" method="POST"
						name="theRemarks">
						<div class="form-group row" style="padding-left: 20%">
							...
							<div class="col-lg-2">
								...
								<button class="btn btn-primary" type="submit"
									ng-disabled="theRemarks.$invalid">Submit</button>
							</div>
						</div>
					</form:form>
				</div>
		...
		myapp
				.controller(
						...
						function($scope, $uibModal, $http) {
							...
							$http
									.get(
											'${pageContext.request.contextPath}/getAPTInboxList')
									.then(function(response) {
										$scope.getAPTInboxList = response.data;
									});
								...
								$http
										...
										.then(
												function(response) {
													...
													$scope.formModel.resourceByAssignedFrom = $scope.getById.resourceByAssignedFrom;
													$scope.formModel.resourceByAssignedTo = $scope.getById.resourceByAssignedTo;
													...
													$scope.formModel.stackHolders = $scope.getById.stackHoldersNames;
													document
															.getElementById("aptStatus").value = $scope.getById.status;
													$scope.aptStatus = $scope.getById.status;
							...
							$scope.addTask = function() {
								$http.put(
										'${pageContext.request.contextPath}'
												+ '/aptStatus/edit/'
												+ $scope.formModel.aptId + '/'
												+ $scope.aptStatus).then(
										function(data) {
											console.log(data);
										});
