...
<body ng-app="CSQ" ng-controller="CSQController" ng-init="init()">
 <a href="${pageContext.request.contextPath}/forgotPassword" ><span class="fa-fw fa fa-arrow-circle-o-left"></span></a> 
	<div class="w3ls-main">
		...
		<div class="wthree-container">
			<div class="wthree-form">
				<form:form method="POST" commandName="confirmSecurityQuestion">
					...
					<div class="w3-user">
						<span><i class="fa fa-quora" aria-hidden="true"></i></span> <input
							type="text" ng-model="security_question" />
					</div>
					<div class="w3-user">
	...
	<script type="text/javascript">
		var myapp = angular.module('CSQ', []);
		myapp.controller('CSQController', function($scope, $http) {
			$scope.init = function() {
				$http.post(
				'${pageContext.request.contextPath}/getSecurityQuestionByUserId')
					.then(function(response) {
					$scope.userInfoTo = response.data;
					$scope.security_question = $scope.userInfoTo.securiyQuestion;
				});
			};
		});
	</script>
