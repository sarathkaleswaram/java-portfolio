		...
		<div id="content">
			...
			<section id="widget-grid" class="">
				...
				<div align="left" class="form-group row">
					<div class="col-lg-3">
						<label for="cli_pm"><span class="asterisc" style="color: red">*</span> Select Project Name </label> <select
							ng-model="formModel.projectId" class="form-control" ng-change="project_manditory=false">
							<option value="">---Please Select---</option>
							<option ng-repeat="row in projectlist" value="{{row.projectId}}">{{row.projectName}}</option>
						</select>
					</div>
					<div id="from" class="col-lg-2">
						<label for="res_fb">From Date</label> <input type="text"
							class="form-control" name="date" id="reciveddate1"
							ng-model="formModel.receivedDate" />
					</div>
					<div id="to" class="col-lg-2">
						<label for="res_fb">To Date</label> <input type="text"
							class="form-control" name="date" id="reciveddate2"
							ng-model="formModel.toDate" />
					</div>
					<div id="buttonSearch" class="col-lg-2">
						<label for="res_fb"> </label>
						<button type="button" class="btn btn-info btn-lg"
							data-toggle="modal" data-target="#myModal" ng-disabled="project_manditory"
									...
									<div style="border: 1px solid black; overflow: auto">
										<table id="datatable_tabletools"
											...
											<tr>
												...
												<th><a href="#"
													ng-click="orderByField='expectedDelivery'; reverseSort = !reverseSort">
														Expected Delivery Date<span
														ng-show="orderByField == 'expectedDelivery'"><span
															ng-show="!reverseSort">^</span><span
															ng-show="reverseSort">v</span></span>
												</a></th>
												<th><a href="#"
