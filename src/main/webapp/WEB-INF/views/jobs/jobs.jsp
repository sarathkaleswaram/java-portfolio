											...
											<tbody id="tableToExport">
												...
												<tr
													...
													<td style="text-align: center;"><a
														...
														href="#" ng-click="jobDelete(job.jobId,job.jobNo)"><span
															ng-show="deleteShow" class="glyphicon glyphicon-trash "></span></a></td>
												</tr>
											</tbody>
										</table>
				...
				<div class="modal-body">
					<div class="main-content">
						<form ng-submit="onSubmit(theForm.$valid)" name="theForm"
							...
							<div class="form-group row">
								<div class="col-lg-4">
									<label for="cli_pro_code"><span class="asterisc">*</span>Centillion
										...
										class="form-control" ng-model="formModel.projectId"
										required="required" ng-change="change(formModel.projectId)">
							...
							<div class="form-group row">
								<div class="col-lg-6">
									<br> <label for="job_id">Job Id</label> <input type="text"
										class="form-control" ng-change="Check(formModel.jobNo,1)"
										ng-model="formModel.jobNo" id="job_id" ng-disabled="false"
										maxlength="250">
									<p ng-show="test1">The Special Character not accept.</p>
								</div>
								<div class="col-lg-6">
									<br> <label for="job_name">Job Name</label> <input
										type="text" class="form-control" ng-model="formModel.jobName"
										id="job_name" ng-disabled="false" maxlength="250">
									<p ng-show="test2">The Special Character not accept.</p>
								</div>
							</div>
							<div class="form-group row">
								<div class="col-lg-2">
									<label for="job_hours"><span class="asterisc">*</span>Estimated Total Job Hours</label> <input
								...
								<div class="col-lg-5">
									<label for="job_stage">Job Stage</label> <select
										name="job_stage" id="job_stage" class="form-control"
										ng-model="formModel.jobStage"
								...
								<div class="col-lg-5">
									<label for="job_status">Job Status</label> <select
										...
										ng-disabled="resourceShow" ng-model="formModel.jobStatus">
							...
							<div class="form-group row seven-cols">
								...
								<div class="col-lg-1 ">
									<label for="res_pro">Production</label> <select name="res_pro"
								...
								<div class="col-lg-1 ">
									<label for="res_qc">QC</label><select name="res_qc" id="res_qc"
										ng-model="formModel.qcResource" class="form-control">
										<option value="" disabled selected hidden></option>
										<option ng-repeat="tm in projectTeamList"
								...
								<div class="col-lg-1">
									<label for="res_qa">QA</label> <select name="res_qa"
										id="res_qa" ng-model="formModel.qaResource"
										class="form-control">
										<option value="" disabled selected hidden></option>
										<option ng-repeat="tm in projectTeamList"
								...
								<div class="col-lg-1 ">
									<label for="res_delivery">Delivery</label> <select
										name="res_delivery" id="res_delivery"
							...
							<div class="form-group row">
								<div class="col-lg-3">
									<label for="res_delivery">Recieved Date</label>
									<div class="date">
								...
								<div class="col-lg-3">
									<label for="res_delivery">Assigned Date</label>
									<div class="date">
										<input type="text" class="form-control" name="date"
								...
								<div class="col-lg-3">
									<label for="res_delivery">Expected Delivery</label>
									<div class="date">
										<input type="text" class="form-control" name="date"
							...
							<div class="form-group">
								<label for="lt_mod">Job Criticality</label><br /> <label
		...
		app
				.controller(
						...
						function(Excel, $timeout, $scope, $http, $filter) {
							$http
									.get(
											'${pageContext.request.contextPath}/jobsList')
